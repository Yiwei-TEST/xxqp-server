...
public class DruidDataSourceFactory implements DataSourceFactory {
    ...
    public void initialize(Map map) {
        ...
        try {
            ...
            LOGGER.info("init DruidDataSource success:url={}", url);
        } catch (Throwable t) {
    ...
    public static final void msg() {
        for (DruidDataSource dataSource : DRUID_DATA_SOURCE_LIST) {
            StringBuilder sb = new StringBuilder("DruidDataSource");
            sb.append("|").append(dataSource.getPoolingCount());
            sb.append("|").append(dataSource.getActiveCount());
            sb.append("|").append(dataSource.getConnectCount());
            sb.append("|").append(dataSource.getCloseCount());
            sb.append("|").append(dataSource.getUrl());
