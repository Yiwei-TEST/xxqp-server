package com.sy599.game.qipai.hgwpaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<HGWPaohuziPlayer> {

    @Override
    public void execute(HGWPaohuziPlayer player, MessageUnit message) throws Exception {
