package com.sy599.game.qipai.nxphz.tool;

import com.sy599.game.GameServerConfig;
import com.sy599.game.qipai.nxphz.bean.GameModel;
import com.sy599.game.qipai.nxphz.bean.PaohuziHandCard;
import com.sy599.game.qipai.nxphz.bean.PaohuziHuBean;
...
public class PaohuziTool {
     ...
     * @date 2019/9/28
     */
    public static synchronized List<List<PaohzCard>> getAllSeatAllCardNew(List<Integer> initAllCardsCombo, List<List<Integer>> gmOptCards, GameModel gameModel) {
        //0庄家的牌,1闲家,2闲家,3剩余牌
...
//            System.out.println(i);
            ...
            if (onlyAdd) {
                ...
                if (fourCount < 0 || threeCount < 0) {
                    allCardStatics.merge(cardId, -1, (oV, nV) -> oV + nV);
                    totalCardCount += 1;
                    //这里把位置调换到最后去,增加最大索引
