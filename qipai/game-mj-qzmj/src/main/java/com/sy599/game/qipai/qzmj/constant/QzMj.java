...
public enum QzMj {
    ...
    static QzMj[] mjArray;
    public static QzMj[] fullMj = new QzMj[34];
    static {
        init();
    }
    ...
    private static void init() {
        int maxVal = 0;
        for(QzMj mj : QzMj.values()) {
            if (mj.getVal() > maxVal && mj.getId() < 300) {
                maxVal = mj.getVal();
            }
        }
        mjArray = new QzMj[maxVal];
        ...
        for(QzMj mj : QzMj.values()) {
           if(mj.getId() < 300){
            ...
            }else if(mj.getVal()>200 && mj.getVal() < 300){
                int yu=mj.getVal()%10;
                int chu=mj.getVal()/10;
                fullMj[chu+yu+6] = mj;
            }else if(mj.getVal() >300 && mj.getVal() < 400){
                int yu=mj.getVal()%10;
                int chu=mj.getVal()/10;
                fullMj[chu+yu-1] = mj;
            }
...
//            if(mj.getId() >= 109 && mj.getId() <= 112){
//                fullMj[mj.getId()-82] = mj;
//            }
//            if (mj.getId() >= 201 && mj.getId() <= 204) {
//                fullMj[mj.getId()-170] = mj;
//            }
    ...
    public static QzMj getMajang(int id) {
        return QzMj.valueOf(QzMj.class, "mj" + id);
    }
    ...
    public static QzMj getMajiangByValue(int value) {
        for (QzMj mj : QzMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static QzMj getMajiangByVal(int val) {
    ...
    public static int getLastMjVal(QzMj mj){
        int mjVal = mj.getVal();
        int yu=mjVal%10;
        int chu=mjVal/10;
        if(mjVal > 200 && mjVal < 300){
            if(chu == 20){
               return 221;
            }else{
               return chu*10-9;
    ...
    public static int getNextMjVal(QzMj mj){
        int mjVal = mj.getVal();
        int yu=mjVal%10;
        int chu=mjVal/10;
        if(mjVal > 200 && mjVal < 300){
