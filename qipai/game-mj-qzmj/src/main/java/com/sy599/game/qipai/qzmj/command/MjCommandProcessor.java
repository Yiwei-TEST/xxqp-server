package com.sy599.game.qipai.qzmj.command;

import com.sy599.game.character.Player;
import com.sy599.game.gcommand.BaseCommand;
import com.sy599.game.qipai.AbstractBaseCommandProcessor;
import com.sy599.game.qipai.qzmj.bean.QzMjPlayer;
import com.sy599.game.qipai.qzmj.command.com.MjComCommand;
import com.sy599.game.qipai.qzmj.command.play.MjPlayCommand;
...
public class MjCommandProcessor extends AbstractBaseCommandProcessor {
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            QzMjPlayer _player = player.getPlayer(processor);
