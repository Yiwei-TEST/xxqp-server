package com.sy599.game.qipai.jhphz281.command;
...
import com.sy599.game.qipai.jhphz281.command.com.PaohuziComCommand;
import com.sy599.game.qipai.jhphz281.command.play.JhPhzPlayCommand;
import com.sy599.game.util.LogUtil;
import com.sy599.game.util.ObjectUtil;
import com.sy599.game.websocket.constant.WebSocketMsgType;
import com.sy599.game.websocket.netty.coder.MessageUnit;

public class JhPhzCommandProcessor extends AbstractBaseCommandProcessor {
	private static JhPhzCommandProcessor processor = new JhPhzCommandProcessor();
	...
	static {
		...
		commandMap.put(WebSocketMsgType.cs_play, JhPhzPlayCommand.class);

	}

	public static JhPhzCommandProcessor getInstance() {
		return processor;
	}
