...
public final class JhPhzCheckCardBean {
	private int seat;
	// 提
	private boolean ti;
	// 碰
	...
	private JhPhzCardResult cardResult;

	public JhPhzCardResult getCardResult() {
		return cardResult;
	}

	public void setCardResult(JhPhzCardResult cardResult) {
