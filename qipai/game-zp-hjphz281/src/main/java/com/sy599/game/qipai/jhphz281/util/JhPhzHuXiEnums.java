...
public enum JhPhzHuXiEnums {
    ...
    JhPhzHuXiEnums(int action, int big, int small) {
        this.action = action;
        this.big = big;
        this.small = small;
    }
     ...
     * @return
     */
    public final static boolean isChi(JhPhzHuXiEnums huXiEnums) {
     ...
     * @return
     */
    public final static boolean isChi0(JhPhzHuXiEnums huXiEnums) {
