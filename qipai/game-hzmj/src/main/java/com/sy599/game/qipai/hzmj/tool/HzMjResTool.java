...
public class HzMjResTool {
	public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<HzMj> majiangs) {
		List<Integer> list = HzMjHelper.toMajiangIds(majiangs);
	 ...
	 * @return
	 */
	public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, HzMj majiang) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		builder.setAction(0);
		builder.setUserId(player.getUserId() + "");
		builder.setSeat(player.getSeat());
