...
public class HzMjCardDisType {
	...
	public boolean isHasCard(HzMj card) {
	...
	public boolean isHasCardVal(int val) {
		if (cardIds != null) {
			List<HzMj> majiangs = HzMjQipaiTool.toMajiang(cardIds);
			List<Integer> vals = HzMjQipaiTool.toMajiangVals(majiangs);
			return vals.contains(val);
		}
		return false;

	}
	public boolean isHasCardVal(HzMj card) {
		if (cardIds != null) {
			List<HzMj> majiangs = HzMjQipaiTool.toMajiang(cardIds);
			List<Integer> vals = HzMjQipaiTool.toMajiangVals(majiangs);
	...
	public int removeCardVal(int val) {
		if (cardIds != null) {
			...
			while (iterator.hasNext()) {
				...
				HzMj majiang = HzMj.getMajang(id);
