package com.sy599.game.qipai.hzmj.command.play;
...
import com.sy599.game.qipai.hzmj.bean.HzMjDisAction;
...
public class HzMjPlayCommand extends BaseCommand {
	@Override
	public void execute(Player player0, MessageUnit message) throws Exception {
		HzMjPlayer player = (HzMjPlayer) player0;
		...
		List<HzMj> majiangs = HzMjHelper.toMajiang(majiangIds);
