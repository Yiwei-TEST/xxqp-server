...
public class HzMjTempAction {

	private int seat;// 玩家位置
	private int action;// 玩家所做的操作
	private List<HzMj> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌
    
    public HzMjTempAction(){
    }
    
    public HzMjTempAction(int seat, int action, List<HzMj> cardList, List<Integer> hucards){
    	this.seat = seat;
		this.action = action;
		if(cardList == null)
	...
	public List<HzMj> getCardList() {
		return cardList;
	}

	public void setCardList(List<HzMj> cardList) {
		this.cardList = cardList;
	}
	...
	public void initData(String data) {
		...
		cardList = HzMjQipaiTool.explodeMajiang(cardStr, ",");//GuihuziTool.explodeGhz(cardStr, ",");
	...
	public String buildData() {
		...
		wrapper.putString(3, StringUtil.implode(HzMjQipaiTool.toMajiangIds(cardList), ","));
