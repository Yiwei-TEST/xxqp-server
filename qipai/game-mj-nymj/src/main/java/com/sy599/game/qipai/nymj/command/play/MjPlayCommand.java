package com.sy599.game.qipai.nymj.command.play;
...
public class MjPlayCommand extends BaseCommand {
    ...
    public void execute(Player player, MessageUnit message) throws Exception {
        NyMjTable table = player.getPlayingTable(NyMjTable.class);
        if (table == null || !(player instanceof NyMjPlayer)) {
            return;
        }
        NyMjPlayer csplayer = (NyMjPlayer) player;
        // 该牌局是否能打牌
        ...
        NyMjPlayer player0 = (NyMjPlayer) player;
