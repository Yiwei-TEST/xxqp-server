...
public class MjRule {
	 ...
	 *
	 */
	public static void checkXiaoHu3(MjiangHu hu, List<Mj> majiangIds, boolean begin, NyMjTable table) {
		int playerNum = 4;
		if (table != null) {
	 ...
	 *
	 */
	public static void checkXiaoHu2(MjiangHu hu, List<Mj> majiangIds, boolean begin, NyMjTable table, NyMjPlayer player) {
		int playerNum = 4;
		if (table != null) {
			playerNum = table.getMaxPlayerCount();
		}
	 ...
	 * @return
	 */
	public static void checkDahu(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, boolean canYingZhuang, NyMjPlayer player, int subKingNum) {
		...
		//玩家当前手牌王数量
		int curkingCardNum = (kingCard != null ? majiangIds.stream().filter(v -> v.getVal() == kingCard.getVal()).mapToInt(v -> 1).sum() : 0) - subKingNum;
...
//				}
	...
	//		13.十八罗汉36分 四条杠加一对将共18张牌胡牌。
			...
			else if (!check7Dui(hu, majiangIds, peng, table, !chi.isEmpty(), gang, subKingNum, kingCard)
	...
	//		12.字一色20分 只有东南西北中发白。
			...
			// 3清一色
			else if (table.getGameModel().getSpecialPlay().isAllOfTheSameColor() && isQingYiSeHu(allMajiangs, majiangIds, subKingNum, kingCard)) {
	//			arr[2] = 1;
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkShiSanYao(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, NyMjPlayer player, Mj kingCard, int curkingCardNum) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkHunYiSe(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, NyMjPlayer player, Mj kingCard, int curkingCardNum, List<Mj> allMajiangs) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkZiYiSe(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, NyMjPlayer player, Mj kingCard, int curkingCardNum, List<Mj> allMajiangs) {
		if (table.getGameModel().isNoneChar() || (hu.getDahuCount() <= 0 && !hu.isHu())) {
			return false;
		}
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkShiBaLuoHan(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, NyMjPlayer player, Mj kingCard, int curkingCardNum) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkYiJiuHu(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, NyMjPlayer player, Mj kingCard, int curkingCardNum, MjIndexArr all_card_index) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkQingYiJiu(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, NyMjTable table, NyMjPlayer player, Mj kingCard, int curkingCardNum, MjIndexArr all_card_index) {
	 ...
	 *@date 2019/10/29
	 */
	private static boolean check7Dui(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, NyMjTable table, boolean existsEat, List<Mj> peng, int subKingNum, Mj...kingCard) {
...
//		int num4 = card_index.getMajiangIndex(3) != null ? card_index.getMajiangIndex(3).getLength() : 0;
		...
		return hu.isXiaodui()||hu.isHao7xiaodui()||hu.isShuang7xiaodui();
	}
...
//		hand = Arrays.asList(11,11,11,11,12,19,13,13,13,14,14,14,26,26);
		...
		System.out.println(isPengPengHu(mjs, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), 0, Mj.getMajang(15)));
	}
}
