...
//            //跟庄+1
     ...
     * @date 2019/9/2
     */
    public static int calcMenZiScore(NyMjTable table, List<Integer> menZiSrc) {
     ...
     * @date 2019/9/2
     */
    public static int calcMenZiScore(NyMjTable table, List<Integer> menZiSrc, int basic) {
        ...
        //將一色+7對算20分
//		if (menZi.contains(1) && menZi.contains(2)) {
//			basic = 20;
//			menZi.removeIf(v->v==1||v==2);
//		}
        ...
        while (iterator.hasNext()) {
            ...
            if (currentCalc != null) {
                //名堂分不叠加,硬庄除外
				if (currentCalc.getE().equals("*") && (currentCalc.getK()==18 || --repeatedIndex >= 0)) {           //*代表乘积
