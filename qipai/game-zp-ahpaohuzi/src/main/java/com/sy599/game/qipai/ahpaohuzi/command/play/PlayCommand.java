package com.sy599.game.qipai.ahpaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<AhPaohuziPlayer> {

    @Override
    public void execute(AhPaohuziPlayer player, MessageUnit message) throws Exception {
