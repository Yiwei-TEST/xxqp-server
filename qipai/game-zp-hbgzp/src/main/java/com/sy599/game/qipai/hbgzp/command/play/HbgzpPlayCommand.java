package com.sy599.game.qipai.hbgzp.command.play;
...
public class HbgzpPlayCommand extends BaseCommand {
	@Override
	public void execute(Player player0, MessageUnit message) throws Exception {
		HbgzpPlayer player = (HbgzpPlayer) player0;
		...
		List<Hbgzp> majiangs = HbgzpHelper.toMajiang(majiangIds);
