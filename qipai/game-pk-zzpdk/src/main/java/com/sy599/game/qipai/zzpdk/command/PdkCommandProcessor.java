package com.sy599.game.qipai.zzpdk.command;

import com.sy599.game.gcommand.BaseCommand;
import com.sy599.game.qipai.AbstractCommandProcessor;
import com.sy599.game.util.ObjectUtil;
import com.sy599.game.qipai.zzpdk.command.play.CutCardCommand;
import com.sy599.game.qipai.zzpdk.command.play.PlayCommand;
...
public class PdkCommandProcessor extends AbstractCommandProcessor<com.sy599.game.qipai.zzpdk.bean.ZZPdkPlayer> {
	private static PdkCommandProcessor processor = new PdkCommandProcessor();
	private static Map<Short, Class<? extends BaseCommand<com.sy599.game.qipai.zzpdk.bean.ZZPdkPlayer>>> commandMap = new HashMap<Short, Class<? extends BaseCommand<com.sy599.game.qipai.zzpdk.bean.ZZPdkPlayer>>>();
...
//		commandMap.put(WebSocketMsgType.cs_com, PdkComCommand.class);
	...
	@Override
	public Map<Short, Class<? extends BaseCommand<com.sy599.game.qipai.zzpdk.bean.ZZPdkPlayer>>> loadCommands() {
		return commandMap;
	}
}
