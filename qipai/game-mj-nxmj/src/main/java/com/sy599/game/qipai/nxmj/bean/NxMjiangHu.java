...
public class NxMjiangHu {
	...
	private HashMap<Integer,Map<Integer,List<NxMj>>> xiaohuMap = new HashMap<>();
	 ...
	 *
	 */
	private List<NxMj> showMajiangs;
	/**
	 * 胡的分数
	 */
	...
	public boolean isYidianhong() {
		return yidianhong;
	}

	public void setYidianhong(boolean yidianhong) {
		this.yidianhong = yidianhong;
	}
	...
	public void setShowMajiangs(List<NxMj> showMajiangs) {
		this.showMajiangs = showMajiangs;
	}

	public List<NxMj> getShowMajiangs() {
		return showMajiangs;
	}
...
//			}
	...
	public void addXiaoHu(int xiaohu,Map<Integer,List<NxMj>> map){
		xiaohuMap.put(xiaohu, map);
	}

	public HashMap<Integer, Map<Integer, List<NxMj>>> getXiaohuMap() {
		return xiaohuMap;
	}
