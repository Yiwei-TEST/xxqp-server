...
/** ExecutionCondition class created from MMPM condition IsZhadan. */
public class IsZhadan extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsZhadan that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.IsZhadan.
	 */
	public IsZhadan(
			com.sy599.game.qipai.pdkuai.robot.conditions.IsZhadan modelTask,
	...
	protected void internalSpawn() {
		...
		LogUtil.printDebug("检测对手出的是不是炸弹");
	}
