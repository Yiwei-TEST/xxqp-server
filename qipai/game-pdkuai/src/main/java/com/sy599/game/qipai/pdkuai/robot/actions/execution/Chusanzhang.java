...
/** ExecutionAction class created from MMPM action Chusanzhang. */
public class Chusanzhang extends jbt.execution.task.leaf.action.ExecutionAction {

	/**
	 * Constructor. Constructs an instance of Chusanzhang that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.actions.Chusanzhang.
	 */
	public Chusanzhang(
			com.sy599.game.qipai.pdkuai.robot.actions.Chusanzhang modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		List<Integer> pais = CardTypeTool.getPaisByPaiXing(CardTypeTool.px_santiao,Arrays.asList(allSantiao.get(0)), handCards);
		if(pais.isEmpty()){
