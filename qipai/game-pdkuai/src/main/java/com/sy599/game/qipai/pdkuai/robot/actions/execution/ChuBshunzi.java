...
/** ExecutionAction class created from MMPM action ChuBshunzi. */
public class ChuBshunzi extends jbt.execution.task.leaf.action.ExecutionAction {

	/**
	 * Constructor. Constructs an instance of ChuBshunzi that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.actions.ChuBshunzi.
	 */
	public ChuBshunzi(
			com.sy599.game.qipai.pdkuai.robot.actions.ChuBshunzi modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
		LogUtil.printDebug("出手牌中最大顺子");//优先牌值-长度
	}
