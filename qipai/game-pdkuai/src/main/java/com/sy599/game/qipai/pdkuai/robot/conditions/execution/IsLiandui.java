...
/** ExecutionCondition class created from MMPM condition IsLiandui. */
public class IsLiandui extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsLiandui that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.IsLiandui.
	 */
	public IsLiandui(
			com.sy599.game.qipai.pdkuai.robot.conditions.IsLiandui modelTask,
	...
	protected void internalSpawn() {
		...
		LogUtil.printDebug("检测对手出的是不是连对");
	}
