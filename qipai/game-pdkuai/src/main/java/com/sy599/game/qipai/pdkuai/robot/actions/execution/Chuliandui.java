...
/** ExecutionAction class created from MMPM action Chuliandui. */
public class Chuliandui extends jbt.execution.task.leaf.action.ExecutionAction {

	/**
	 * Constructor. Constructs an instance of Chuliandui that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.actions.Chuliandui.
	 */
	public Chuliandui(
			com.sy599.game.qipai.pdkuai.robot.actions.Chuliandui modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		List<Integer> pais = CardTypeTool.getPaisByPaiXing(CardTypeTool.px_liandui, myShunzi, handCards);
		if(pais.isEmpty()){
