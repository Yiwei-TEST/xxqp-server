...
/** ExecutionAction class created from MMPM action ChuJBdanpai. */
public class ChuJBdanpai extends jbt.execution.task.leaf.action.ExecutionAction {

	/**
	 * Constructor. Constructs an instance of ChuJBdanpai that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.actions.ChuJBdanpai.
	 */
	public ChuJBdanpai(
			com.sy599.game.qipai.pdkuai.robot.actions.ChuJBdanpai modelTask,
