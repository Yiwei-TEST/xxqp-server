...
/** ExecutionCondition class created from MMPM condition HasDuizi. */
public class HasDuizi extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of HasDuizi that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.HasDuizi.
	 */
	public HasDuizi(
			com.sy599.game.qipai.pdkuai.robot.conditions.HasDuizi modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		int myMaxSantiao = allSantiao.get(0);
