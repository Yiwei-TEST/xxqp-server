...
/** ExecutionCondition class created from MMPM condition HasJBdanpai. */
public class HasJBdanpai extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of HasJBdanpai that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.HasJBdanpai.
	 */
	public HasJBdanpai(
			com.sy599.game.qipai.pdkuai.robot.conditions.HasJBdanpai modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
		LogUtil.printDebug("判断是否有绝对最大单牌");
	}
