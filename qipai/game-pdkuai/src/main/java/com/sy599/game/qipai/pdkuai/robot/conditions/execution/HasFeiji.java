...
/** ExecutionCondition class created from MMPM condition HasFeiji. */
public class HasFeiji extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of HasFeiji that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.HasFeiji.
	 */
	public HasFeiji(
			com.sy599.game.qipai.pdkuai.robot.conditions.HasFeiji modelTask,
