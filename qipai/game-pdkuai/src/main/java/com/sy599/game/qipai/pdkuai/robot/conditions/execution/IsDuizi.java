...
/** ExecutionCondition class created from MMPM condition IsDuizi. */
public class IsDuizi extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsDuizi that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.IsDuizi.
	 */
	public IsDuizi(
			com.sy599.game.qipai.pdkuai.robot.conditions.IsDuizi modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
		LogUtil.printDebug("检测对手出的是不是对子");
	}
