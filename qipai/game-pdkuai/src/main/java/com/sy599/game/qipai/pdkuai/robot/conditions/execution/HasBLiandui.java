...
/** ExecutionCondition class created from MMPM condition HasBLiandui. */
public class HasBLiandui extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of HasBLiandui that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.HasBLiandui.
	 */
	public HasBLiandui(
			com.sy599.game.qipai.pdkuai.robot.conditions.HasBLiandui modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(residueCards.isEmpty()){
			LogUtil.printDebug("没有未出现的牌，是最大连对");
		...
		List<List<Integer>> residueShunzi = residuePaixing.get(CardTypeTool.px_liandui);
		if(residueShunzi.isEmpty()){
			LogUtil.printDebug("剩余牌中没有连对");
			return jbt.execution.core.ExecutionTask.Status.SUCCESS;
		}
