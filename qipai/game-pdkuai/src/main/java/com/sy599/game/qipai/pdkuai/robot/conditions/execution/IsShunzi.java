...
/** ExecutionCondition class created from MMPM condition IsShunzi. */
public class IsShunzi extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsShunzi that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.IsShunzi.
	 */
	public IsShunzi(
			com.sy599.game.qipai.pdkuai.robot.conditions.IsShunzi modelTask,
	...
	protected void internalSpawn() {
		...
		LogUtil.printDebug("检测对手出的是不是顺子");
	}
