...
/** ExecutionCondition class created from MMPM condition HasJBDuizi. */
public class HasJBDuizi extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of HasJBDuizi that is able to run a
	 * com.sy599.game.qipai.pdkuai.robot.conditions.HasJBDuizi.
	 */
	public HasJBDuizi(
			com.sy599.game.qipai.pdkuai.robot.conditions.HasJBDuizi modelTask,
...
//		LogUtil.printDebug(this.getClass().getCanonicalName() + " spawned");
		LogUtil.printDebug("检测是否有绝对最大对子");
	}
