package com.sy599.game.qipai.yzlc.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<YzLcPaohuziPlayer> {

    @Override
    public void execute(YzLcPaohuziPlayer player, MessageUnit message) throws Exception {
        YzLcPaohuziTable table = player.getPlayingTable(YzLcPaohuziTable.class);
