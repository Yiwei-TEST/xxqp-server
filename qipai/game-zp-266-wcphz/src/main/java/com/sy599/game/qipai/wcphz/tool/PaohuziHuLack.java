...
public class PaohuziHuLack implements Cloneable {
	...
	private boolean isPaoHu;

	private int cardSrcSize;
	...
	public int getCardSrcSize() {
		return cardSrcSize;
	}

	public void setCardSrcSize(int cardSrcSize) {
		this.cardSrcSize = cardSrcSize;
	}
...
//		this.isPaoHu = isNeedDui;
	}

	public boolean isPaoHu() {
		return isPaoHu;
	}

	public void setPaoHu(boolean isPaoHu) {
		this.isPaoHu = isPaoHu;
	}
