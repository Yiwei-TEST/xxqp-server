...
//    private int autoOutCard;
    ...
    */
	...
	public boolean signFlutterAllOver() {
		return (getSpecialPlay().getFlutterScoreType2() <= 0 && !getSpecialPlay().isFlutter()) || flutterScore == -1;
	}
    ...
    public static class SpecialPlay {
        ...
        //自由飘开关
        private int flutterScoreType;
        //坐飘开关
        private int flutterScoreType2;
        //30胡算作10分,15分
        private int threeTenHu;
        //n胡算作10分,15分 的条件变量值
		private int threeTenHuBasic;
        //arriveAddNBasic胡息以上见1+n
        private int arriveAddN;
        //0臭牌臭庄,1臭牌不臭庄
        private int passCardPassMaster;
