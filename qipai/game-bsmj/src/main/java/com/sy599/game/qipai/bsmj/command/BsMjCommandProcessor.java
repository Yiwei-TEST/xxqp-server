package com.sy599.game.qipai.bsmj.command;

import com.sy599.game.character.Player;
import com.sy599.game.gcommand.BaseCommand;
import com.sy599.game.qipai.AbstractBaseCommandProcessor;
import com.sy599.game.qipai.bsmj.bean.BsMjPlayer;
import com.sy599.game.qipai.bsmj.command.com.BsMjComCommand;
import com.sy599.game.qipai.bsmj.command.play.BsMjPlayCommand;
...
public class BsMjCommandProcessor extends AbstractBaseCommandProcessor {
    private static BsMjCommandProcessor processor = new BsMjCommandProcessor();
    ...
    static {
        commandMap.put(WebSocketMsgType.cs_com, BsMjComCommand.class);
        commandMap.put(WebSocketMsgType.cs_play, BsMjPlayCommand.class);
    ...
    public static BsMjCommandProcessor getInstance() {
        return processor;
    }
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            if (player == null || !(player instanceof BsMjPlayer)) {
                return;
            }
            BsMjPlayer csMajiangPlayer = player.getPlayer(processor);
