package com.sy599.game.qipai.bsmj.command.com;
...
public class BsMjComCommand extends BaseCommand<BsMjPlayer> {
	...
	@Override
	public void execute(BsMjPlayer player, MessageUnit message) throws Exception {
		...
		if (req.getCode() == WebSocketMsgType.req_com_lastmajiang) {
			...
			table.playBaoting(player,baoting);
		        ...
		        LogUtil.msg("BsMjComCommand|baoting|" + player.getPlayingTableId() + "|" + player.getSeat() + "|" + player.getUserId() + "|" + baoting+ "|" );
		}
