...
public class PhzTest {
    public static void main(String[] args) {
        LdsPhzHandCards handCards = new LdsPhzHandCards(Arrays.asList(1,11,51,61,63,2,3,4,14,54,64,55,65,75,7,57,67,60,59,58));
...
//        handCards.CHI_COMMON.add(Arrays.asList(18,19,20));
        ...
        LdsPhzBase phzBase = new LdsPhzBase() {
            @Override
        ...
        LdsPhzCardResult cardResult = LdsPhzHuPaiUtils.huPai(handCards,52,phzBase,true,"test",52);
