...
public class SyMjTempAction {

	private int seat;// 玩家位置
	private int action;// 玩家所做的操作
	private List<SyMj> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌
    
    public SyMjTempAction(){
    }
    
    public SyMjTempAction(int seat, int action, List<SyMj> cardList, List<Integer> hucards){
    	this.seat = seat;
		this.action = action;
		if(cardList == null)
	...
	public List<SyMj> getCardList() {
		return cardList;
	}

	public void setCardList(List<SyMj> cardList) {
		this.cardList = cardList;
	}
	...
	public void initData(String data) {
		...
		cardList = SyMjQipaiTool.explodeMajiang(cardStr, ",");//GuihuziTool.explodeGhz(cardStr, ",");
	...
	public String buildData() {
		...
		wrapper.putString(3, StringUtil.implode(SyMjQipaiTool.toMajiangIds(cardList), ","));
