...
public class SyMjResTool {
	public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<SyMj> majiangs) {
		List<Integer> list = SyMjHelper.toMajiangIds(majiangs);
	 ...
	 * @return
	 */
	public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, SyMj majiang) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		builder.setAction(0);
		builder.setUserId(player.getUserId() + "");
		builder.setSeat(player.getSeat());
