...
public class SyMjCardDisType {
	...
	public boolean isHasCard(SyMj card) {
	...
	public boolean isHasCardVal(int val) {
		if (cardIds != null) {
			List<SyMj> majiangs = SyMjQipaiTool.toMajiang(cardIds);
			List<Integer> vals = SyMjQipaiTool.toMajiangVals(majiangs);
			return vals.contains(val);
		}
		return false;

	}
	public boolean isHasCardVal(SyMj card) {
		if (cardIds != null) {
			List<SyMj> majiangs = SyMjQipaiTool.toMajiang(cardIds);
			List<Integer> vals = SyMjQipaiTool.toMajiangVals(majiangs);
	...
	public int removeCardVal(int val) {
		if (cardIds != null) {
			...
			while (iterator.hasNext()) {
				...
				SyMj majiang = SyMj.getMajang(id);
