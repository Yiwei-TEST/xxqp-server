...
public class Program {
    ...
    public static void generateFile() {
		System.out.println("generate ting table begin...");
        long start = System.currentTimeMillis();
        TableMgr.getInstance().load();
        TableMgr.getInstance().gen_ting_table();
        TableMgr.getInstance().dump_ting_table();
		System.out.println("generate ting table end..." + (System.currentTimeMillis() - start));
    }
