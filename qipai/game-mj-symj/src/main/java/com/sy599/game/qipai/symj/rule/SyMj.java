...
public enum SyMj {
    ...
    private int val;
    static SyMj[] mjArray;
    public static SyMj[] fullMj = new SyMj[34];
    ...
    public static SyMj getMajang(int id) {
        return SyMj.valueOf(SyMj.class, "mj" + id);
    }
    ...
    public static SyMj getMajiangByValue(int value) {
        for (SyMj mj : SyMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static SyMj getMajiangByVal(int val) {
