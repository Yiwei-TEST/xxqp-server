...
public class DehMjDisAction {
	...
	/** 小胡展示一圈的牌不隐藏**/
	public static final int action_hideMj = 21;
	/** 不摸海底*/
	...
	/** 根牌显示*/
	public static final int action_Gen_SHOW = 1200;
	...
	public static List<Integer> parseToDisActionList(List<Integer> actionList) {
		...
		for(int action = 6; action < DehMjAction.ACTION_SIZE; action ++) {
