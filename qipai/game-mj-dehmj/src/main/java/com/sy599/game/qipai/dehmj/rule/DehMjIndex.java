...
public class DehMjIndex {
	private Map<Integer, List<DehMj>> majiangValMap;
	...
	public void addMajiang(int val, List<DehMj> majiangs) {
		if (this.majiangValMap == null) {
			this.majiangValMap = new HashMap<Integer, List<DehMj>>();
		}
	...
	public List<DehMj> getMajiangs(){
		List<DehMj> majiangs=new ArrayList<>();
		if(majiangValMap!=null){
			for(Entry<Integer, List<DehMj>> entry: majiangValMap.entrySet()){
	...
	public Map<Integer, List<DehMj>> getMajiangValMap() {
		return majiangValMap;
	}

	public void setMajiangValMap(Map<Integer, List<DehMj>> majiangValMap) {
