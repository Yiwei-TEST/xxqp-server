package com.sy599.game.qipai.dehmj.tool.hulib.util;
...
import com.sy599.game.qipai.dehmj.tool.hulib.core.handle.Hulib;
import com.sy599.game.qipai.dehmj.tool.hulib.core.handle.TableMgr;
...
public class HuUtil {
    ...
    public static boolean isCanHu(List<DehMj> cards, int gui_num) {
    ...
    public static List<DehMj> getLackPaiList(List<DehMj> cards, int gui_num) {
        int[] cardsArr = toCardArray(cards);
        boolean any = false;
        if (gui_num > 0) {
    ...
    public static int[] toCardArray(List<DehMj> cards) {
        int[] cardsArr = new int[34];
        Arrays.fill(cardsArr, 0);

        for (int i = 0; i < cards.size(); i++) {
            DehMj card = cards.get(i);
    ...
    private static DehMj index2Majiang(int index) {
        int type = index / 9 + 1;
        ...
        return DehMj.getMajiangByVal(val);
    }

    private static List<DehMj> toRawCards(List<Integer> list) {
        List<DehMj> retList = new ArrayList<>();
        for (int index : list) {
    ...
    public static int getMjIndex(DehMj card) {
        return val2Index.get(card.getVal());
    }
    
    public static void main(String args[]) {
//    	com.sy599.game.qipai.dehmj.tool.hulib.core.gen_feng_table.Program.gen();
//    	com.sy599.game.qipai.dehmj.tool.hulib.core.gen_table.Program.gen();
//    	com.sy599.game.qipai.dehmj.tool.hulib.core.gen_ting_table.Program.gen();
    }
