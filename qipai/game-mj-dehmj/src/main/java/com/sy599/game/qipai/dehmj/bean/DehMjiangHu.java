...
public class DehMjiangHu {
	 ...
	 *
	 */
	private List<DehMj> showMajiangs;
	/**
	 * 胡的分数
	 */
	private int dahuFan;
...
//		addFan(1);
	...
	public void setShowMajiangs(List<DehMj> showMajiangs) {
		this.showMajiangs = showMajiangs;
	}

	public List<DehMj> getShowMajiangs() {
		return showMajiangs;
	}
