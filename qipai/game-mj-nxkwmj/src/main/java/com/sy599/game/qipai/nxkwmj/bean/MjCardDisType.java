...
import com.sy599.game.qipai.nxkwmj.tool.MjQipaiTool;
...
public class MjCardDisType {
    ...
    public boolean isHasCard(KwMj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<KwMj> majiangs = MjQipaiTool.toMajiang(cardIds);
    ...
    public boolean isHasCardVal(KwMj card) {
        if (cardIds != null) {
            List<KwMj> majiangs = MjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = MjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                KwMj majiang = KwMj.getMajang(id);
