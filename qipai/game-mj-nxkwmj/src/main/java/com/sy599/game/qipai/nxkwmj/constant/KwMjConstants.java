package com.sy599.game.qipai.nxkwmj.constant;
...
//        cx_mjList.add(1005);
    ...
    public static List<KwMj> getMajiangPai(int playerCount) {
        List<KwMj> majiangs = new ArrayList<>();
        if (playerCount == 2) {
            for (int i = 19; i <= 27; i++) {
                majiangs.add(KwMj.getMajang(i));
            }
            majiangs.add(KwMj.getMajang(109));
            majiangs.add(KwMj.getMajang(113));
            majiangs.add(KwMj.getMajang(117));
            majiangs.add(KwMj.getMajang(121));
            majiangs.add(KwMj.getMajang(201));
            majiangs.add(KwMj.getMajang(205));
            majiangs.add(KwMj.getMajang(209));
        } else {
            for (int i = 1; i <= 27; i++) {
                majiangs.add(KwMj.getMajang(i));
            }
