package com.sy599.game.qipai.nxkwmj.command;
...
import com.sy599.game.qipai.nxkwmj.command.com.MjComCommand;
import com.sy599.game.qipai.nxkwmj.command.play.MjPlayCommand;
...
public class MjCommandProcessor extends AbstractBaseCommandProcessor {
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            KwMjPlayer _player = player.getPlayer(processor);
