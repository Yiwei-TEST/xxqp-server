...
public enum KwMj {
    ...
    static KwMj[] mjArray;
    public static KwMj[] fullMj = new KwMj[27];
    static {
        init();
    }
    ...
    private static void init() {
        int maxVal = 0;
        for(KwMj mj : KwMj.values()) {
            if (mj.getVal() > maxVal && mj.getId() < 300) {
                maxVal = mj.getVal();
            }
        }
        mjArray = new KwMj[maxVal];
    ...
    public static KwMj getMajang(int id) {
        return KwMj.valueOf(KwMj.class, "mj" + id);
    }
    ...
    public static KwMj getMajiangByValue(int value) {
        for (KwMj mj : KwMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static KwMj getMajiangByVal(int val) {
