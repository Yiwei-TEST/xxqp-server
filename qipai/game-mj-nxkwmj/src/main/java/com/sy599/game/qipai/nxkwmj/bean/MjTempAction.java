...
public class MjTempAction {
    ...
    private List<KwMj> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌

    public MjTempAction() {
    }

    public MjTempAction(int seat, int action, List<KwMj> cardList, List<Integer> hucards) {
        this.seat = seat;
        this.action = action;
        if (cardList == null)
    ...
    public List<KwMj> getCardList() {
        return cardList;
    }

    public void setCardList(List<KwMj> cardList) {
        this.cardList = cardList;
    }
