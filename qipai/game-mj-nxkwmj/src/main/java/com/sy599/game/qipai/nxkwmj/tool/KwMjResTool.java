...
public class KwMjResTool {
    public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<KwMj> majiangs) {
     ...
     * @return
     */
    public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, KwMj majiang) {
        PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
        builder.setAction(0);
        builder.setUserId(player.getUserId() + "");
        builder.setSeat(player.getSeat());
