...
@NoArgsConstructor
@AllArgsConstructor
public class CompetitionPlayingDB extends CompetitionBaseDBPojo {
	public static final String SPACE_NAME = SPACE_NAME_1 + ".playing";
	...
	private Integer type;// 比赛类型 1人满 2定时
	...
	private Integer aliveHuman;// 当前存活
	...
	private String beginPlayingRHLPushStatus;	//赛前跑马灯推送
	...
	private Integer upStep;// 上一个进行到轮次

	private Integer upRound;// 上一个进行到回合数
