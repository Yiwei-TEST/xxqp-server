 ...
 * h5 wmpay
 */
public class WebWmPay extends BaseSdk {
        ...
        if (msg.getCode() == 0) {
            try {
                ...
                if (config != null) {
                    ...
                    map.put("cardno", "32");
                    map.put("noticeurl", loadPayUrl(getRequest(),"support!ovali_com","pay!webwmpay"));
                    ...
                    String url="http://vip.wmcard.cn/intf/wapwpay.html?"+stringBuilder.substring(1);
//                    String ret=HttpUtil.getUrlReturnValue(url);

//                    String payUrl = null;
//                    if (ret!=null){
//                        int idx = ret.indexOf("\"weixin:");
//                        if (idx>-1){
//                            payUrl = ret.substring(idx+1,ret.indexOf("\"",idx+1));
//                        }else{
//                            idx = ret.indexOf("'weixin:");
//                            if (idx>-1){
//                                payUrl = ret.substring(idx+1,ret.indexOf("'",idx+1));
//                            }
//                        }
//                    }
                    ...
                    LogUtil.i("create order url:"+url);

//                    if (payUrl!=null) {
                        Map<String, Object> urlMap = new HashMap<>();
                        urlMap.put("pay_info", url);
