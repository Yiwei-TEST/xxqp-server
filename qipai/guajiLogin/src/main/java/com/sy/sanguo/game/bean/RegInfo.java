...
public class RegInfo implements Serializable {
	...
	public int getIsReceiveBDAward() {
		return isReceiveBDAward;
	}

	public void setIsReceiveBDAward(int isReceiveBDAward) {
		this.isReceiveBDAward = isReceiveBDAward;
	}
