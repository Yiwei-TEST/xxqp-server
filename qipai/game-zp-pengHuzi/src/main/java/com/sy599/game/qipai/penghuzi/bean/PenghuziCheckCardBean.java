...
public class PenghuziCheckCardBean {
	private int seat;
	// 提
	private boolean ti;
	// 碰
	...
	private PenghzCard disCard;
	private List<Integer> actionList;
	private List<PenghzCard> autoDisList;
	private boolean isMoPaiIng;
	private  PenghuziHuLack lack;
	//过掉胡
	...
	public List<PenghzCard> getAutoDisList() {
		return autoDisList;
	}

	public void setAuto(int autoAction, List<PenghzCard> autoDisList) {
...
//		}
	...
	public PenghzCard getDisCard() {
		return disCard;
	}

	public void setDisCard(PenghzCard disCard) {
	...
	public void initAutoDisData(String data) {
		if (!StringUtils.isBlank(data)) {
			...
			if (!StringUtils.isBlank(autoDisStr)) {
				this.autoDisList = PenghuziTool.explodePhz(autoDisStr, ",");
			}
	...
	public String buildAutoDisStr() {
		...
		sb.append(PenghuziTool.implodePhz(autoDisList, ",")).append(";");
		sb.append(isMoPaiIng ? 1 : 0).append(";");
		sb.append(isPassHu ? 1 : 0).append(";");
		return sb.toString();
	}

	public PenghuziHuLack getLack() {
		return lack;
	}

	public void setLack(PenghuziHuLack lack) {
		this.lack = lack;
	}
