...
public class PenghuziDisAction {
	/** 胡 **/
	...
	public static List<Integer> findPriorityAction(int action) {
		...
		if (action == PenghuziDisAction.action_chi) {
			findActionList = Arrays.asList(PenghuziDisAction.action_hu, PenghuziDisAction.action_minggang, PenghuziDisAction.action_buzhang, PenghuziDisAction.action_peng);

		} else if (action == PenghuziDisAction.action_peng) {
			findActionList = Arrays.asList(PenghuziDisAction.action_hu, PenghuziDisAction.action_minggang, PenghuziDisAction.action_buzhang);

		} else if (action == PenghuziDisAction.action_buzhang) {
			findActionList = Arrays.asList(PenghuziDisAction.action_hu, PenghuziDisAction.action_minggang);

		} else if (action == PenghuziDisAction.action_minggang) {
			findActionList = Arrays.asList(PenghuziDisAction.action_hu);
