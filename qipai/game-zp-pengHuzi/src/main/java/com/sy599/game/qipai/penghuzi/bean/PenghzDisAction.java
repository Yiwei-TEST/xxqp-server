...
public class PenghzDisAction {
	...
	/** 碰胡子加分日志记录**/
	public static final int action_jiaFen= 108;
	
	/** 碰胡子庄x日志记录**/
	public static final int action_Zhuang= 109;
	
	/** 碰胡子庄五福报警灯日志记录**/
	public static final int action_WUFU_DENG= 110;
