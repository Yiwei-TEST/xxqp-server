...
/** ExecutionCondition class created from MMPM condition IsKaBianZhang. */
public class IsKaBianZhang extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsKaBianZhang that is able to run
	 * a com.sy599.game.qipai.csmj.robot.conditions.IsKaBianZhang.
	 */
	public IsKaBianZhang(
			com.sy599.game.qipai.csmj.robot.conditions.IsKaBianZhang modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsKaBianZhang(list);
