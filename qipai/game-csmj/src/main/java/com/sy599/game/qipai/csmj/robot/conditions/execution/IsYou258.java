...
/** ExecutionCondition class created from MMPM condition IsYou258. */
public class IsYou258 extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsYou258 that is able to run a
	 * com.sy599.game.qipai.csmj.robot.conditions.IsYou258.
	 */
	public IsYou258(
			com.sy599.game.qipai.csmj.robot.conditions.IsYou258 modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsYou258(list);
