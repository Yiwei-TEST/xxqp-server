...
public class IsJiePai extends
	 ...
	 * com.sy599.game.qipai.csmj.robot.conditions.IsJiePai.
	 */
	public IsJiePai(
			com.sy599.game.qipai.csmj.robot.conditions.IsJiePai modelTask,
	...
	protected Status internalTick() {
		 ...
		 */
		boolean canAction = (boolean) getContext().getVariable("jiepai");
		if(canAction){
			LogUtil.printDebug(getContext().getVariable("userName")+" action:jie="+!canAction);
