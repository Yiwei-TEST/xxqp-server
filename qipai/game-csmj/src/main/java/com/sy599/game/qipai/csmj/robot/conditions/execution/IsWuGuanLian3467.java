...
/** ExecutionCondition class created from MMPM condition IsWuGuanLian3467. */
public class IsWuGuanLian3467 extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsWuGuanLian3467 that is able to
	 * run a com.sy599.game.qipai.csmj.robot.conditions.IsWuGuanLian3467.
	 */
	public IsWuGuanLian3467(
			com.sy599.game.qipai.csmj.robot.conditions.IsWuGuanLian3467 modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsWuGuanLian3467(list);
