...
/** ExecutionCondition class created from MMPM condition IsWuGuanLian258. */
public class IsWuGuanLian258 extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsWuGuanLian258 that is able to
	 * run a com.sy599.game.qipai.csmj.robot.conditions.IsWuGuanLian258.
	 */
	public IsWuGuanLian258(
			com.sy599.game.qipai.csmj.robot.conditions.IsWuGuanLian258 modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsWuGuanLian258(list);
