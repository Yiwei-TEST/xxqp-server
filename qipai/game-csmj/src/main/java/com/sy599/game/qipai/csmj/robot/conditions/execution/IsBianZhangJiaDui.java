...
/** ExecutionCondition class created from MMPM condition IsBianZhangJiaDui. */
public class IsBianZhangJiaDui extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsBianZhangJiaDui that is able to
	 * run a com.sy599.game.qipai.csmj.robot.conditions.IsBianZhangJiaDui.
	 */
	public IsBianZhangJiaDui(
			com.sy599.game.qipai.csmj.robot.conditions.IsBianZhangJiaDui modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsBianZhangJiaDui(list);
