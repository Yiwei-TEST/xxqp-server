...
/** ExecutionAction class created from MMPM action gang. */
public class gang extends jbt.execution.task.leaf.action.ExecutionAction {

	/**
	 * Constructor. Constructs an instance of gang that is able to run a
	 * com.sy599.game.qipai.csmj.robot.actions.gang.
	 */
	public gang(com.sy599.game.qipai.csmj.robot.actions.gang modelTask,
