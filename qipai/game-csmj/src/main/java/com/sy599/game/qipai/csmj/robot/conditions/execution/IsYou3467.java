...
/** ExecutionCondition class created from MMPM condition IsYou3467. */
public class IsYou3467 extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsYou3467 that is able to run a
	 * com.sy599.game.qipai.csmj.robot.conditions.IsYou3467.
	 */
	public IsYou3467(
			com.sy599.game.qipai.csmj.robot.conditions.IsYou3467 modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsYou3479(list);
