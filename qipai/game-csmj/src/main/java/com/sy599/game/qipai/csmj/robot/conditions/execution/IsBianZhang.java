...
/** ExecutionCondition class created from MMPM condition IsBianZhang. */
public class IsBianZhang extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsBianZhang that is able to run a
	 * com.sy599.game.qipai.csmj.robot.conditions.IsBianZhang.
	 */
	public IsBianZhang(
			com.sy599.game.qipai.csmj.robot.conditions.IsBianZhang modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsBianZhang(list);
