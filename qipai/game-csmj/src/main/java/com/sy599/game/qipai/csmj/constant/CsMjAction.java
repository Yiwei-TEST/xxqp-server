package com.sy599.game.qipai.csmj.constant;
...
public class CsMjAction {
    ...
    public static boolean hasHu(List<Integer> actionList) {
        return hasAction(actionList, CsMjAction.HU) || hasAction(actionList,ZIMO);
    }
    ...
    public static boolean hasGang(List<Integer> actionList) {
        return hasAction(actionList, CsMjAction.MINGGANG);
    }
