...
/** ExecutionCondition class created from MMPM condition IsXiangLianJiaKa. */
public class IsXiangLianJiaKa extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsXiangLianJiaKa that is able to
	 * run a com.sy599.game.qipai.csmj.robot.conditions.IsXiangLianJiaKa.
	 */
	public IsXiangLianJiaKa(
			com.sy599.game.qipai.csmj.robot.conditions.IsXiangLianJiaKa modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsXiangLianJiaKa(list);
