package com.sy599.game.qipai.csmj.command.com;
...
public class CsMjComCommand extends BaseCommand<CsMjPlayer> {
	...
	@Override
	public void execute(CsMjPlayer player, MessageUnit message) throws Exception {
