...
/** ExecutionCondition class created from MMPM condition IsKaZhangJiaDui. */
public class IsKaZhangJiaDui extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsKaZhangJiaDui that is able to
	 * run a com.sy599.game.qipai.csmj.robot.conditions.IsKaZhangJiaDui.
	 */
	public IsKaZhangJiaDui(
			com.sy599.game.qipai.csmj.robot.conditions.IsKaZhangJiaDui modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsKaZhangJiaDui(list);
