...
public class CsMjResTool {
	public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<CsMj> majiangs) {
		List<Integer> list = CsMjHelper.toMajiangIds(majiangs);
	 ...
	 * @return
	 */
	public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, CsMj majiang) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		builder.setAction(0);
		builder.setUserId(player.getUserId() + "");
		builder.setSeat(player.getSeat());
	...
	public static PlayMajiangRes.Builder buildPlayRes(Player player, int action, List<CsMj> majiangs) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		List<Integer> list = CsMjHelper.toMajiangIds(majiangs);
		builder.addAllMajiangIds(list);
		builder.setAction(action);
