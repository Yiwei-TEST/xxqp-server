...
/** ExecutionCondition class created from MMPM condition IsKaZhang. */
public class IsKaZhang extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsKaZhang that is able to run a
	 * com.sy599.game.qipai.csmj.robot.conditions.IsKaZhang.
	 */
	public IsKaZhang(
			com.sy599.game.qipai.csmj.robot.conditions.IsKaZhang modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsKaZhang(list);
