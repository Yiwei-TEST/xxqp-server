...
/** ExecutionCondition class created from MMPM condition IsDanDui. */
public class IsDanDui extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsDanDui that is able to run a
	 * com.sy599.game.qipai.csmj.robot.conditions.IsDanDui.
	 */
	public IsDanDui(
			com.sy599.game.qipai.csmj.robot.conditions.IsDanDui modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		LogUtil.printDebug(this.getClass().getCanonicalName()+" YichuPaixing:");
		if(result){
			List<CsMj> list = (List<CsMj>) getContext().getVariable("YichuPaixingCard");
			LogUtil.printDebug("list==="+list);
			List<CsMj> res = MajiangAITool.IsDanDui(list);
