...
/** ExecutionCondition class created from MMPM condition IsXiangLianJiaDui. */
public class IsXiangLianJiaDui extends
		jbt.execution.task.leaf.condition.ExecutionCondition {

	/**
	 * Constructor. Constructs an instance of IsXiangLianJiaDui that is able to
	 * run a com.sy599.game.qipai.csmj.robot.conditions.IsXiangLianJiaDui.
	 */
	public IsXiangLianJiaDui(
			com.sy599.game.qipai.csmj.robot.conditions.IsXiangLianJiaDui modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(result){
			...
			List<CsMj> res = MajiangAITool.IsXiangLianJiaDui(list);
