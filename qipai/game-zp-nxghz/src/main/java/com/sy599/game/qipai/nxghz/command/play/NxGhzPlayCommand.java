package com.sy599.game.qipai.nxghz.command.play;

import com.sy599.game.character.Player;
import com.sy599.game.common.constant.LangMsg;
import com.sy599.game.common.constant.SharedConstants.table_state;
import com.sy599.game.gcommand.BaseCommand;
import com.sy599.game.qipai.nxghz.bean.NxGhzCheckCardBean;
...
public class NxGhzPlayCommand extends BaseCommand {
    @Override
    public void execute(Player player0, MessageUnit message) throws Exception {
        ...
        if (action == NxGhzDisAction.action_pass) {// 客户端过的操作
            ...
            if (actionMap != null && actionMap.containsKey(player.getSeat())) {
                ...
                if (!cards.isEmpty()) {
                    ...
                    List<NxGhzCard> nowDisCards = table.getNowDisCardIds();
                    if (nowDisCards != null && !nowDisCards.isEmpty() && !NxGhzCheckCardBean.hasLiu(list) && !NxGhzCheckCardBean.hasHu(list)) {
