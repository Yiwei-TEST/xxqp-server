 ...
 */
public class NxGhzCheckCardBean {
     ...
     * 胡牌时相关信息
     */
    private NxGhzHuLack lack;
    /**
     * 过掉胡
     */
    private boolean isPassHu;

    public NxGhzCheckCardBean() {
    }

    public NxGhzCheckCardBean(int seat, NxGhzCard disCard) {
        this.seat = seat;
    ...
    public NxGhzCard getDisCard() {
        return disCard;
    }

    public void setDisCard(NxGhzCard disCard) {
        this.disCard = disCard;
    }
    ...
    public NxGhzHuLack getLack() {
        return lack;
    }

    public void setLack(NxGhzHuLack lack) {
        this.lack = lack;
    }
