package com.sy599.game.qipai.nxghz.constant;

import java.util.List;

public enum NxGhzCard {
    ...
    public static NxGhzCard getGuihzCard(List<NxGhzCard> cards, int value) {
        for (NxGhzCard card : NxGhzCard.values()) {
    ...
    public static NxGhzCard getGuihzCard(int value) {
        for (NxGhzCard card : NxGhzCard.values()) {
    ...
    public static NxGhzCard getPaohzCard(int id) {
        if (id == 0) {
            return null;
        }
        return NxGhzCard.valueOf(NxGhzCard.class, "phz" + id);
    }
