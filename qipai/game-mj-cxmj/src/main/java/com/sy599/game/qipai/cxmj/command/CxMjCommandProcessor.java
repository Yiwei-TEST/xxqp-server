package com.sy599.game.qipai.cxmj.command;
...
import com.sy599.game.qipai.cxmj.command.com.CxMjComCommand;
import com.sy599.game.qipai.cxmj.command.play.CxMjPlayCommand;
import com.sy599.game.util.LogUtil;
import com.sy599.game.websocket.constant.WebSocketMsgType;
import com.sy599.game.websocket.netty.coder.MessageUnit;

public class CxMjCommandProcessor extends AbstractBaseCommandProcessor {
    private static CxMjCommandProcessor processor = new CxMjCommandProcessor();
    ...
    static {
        commandMap.put(WebSocketMsgType.cs_com, CxMjComCommand.class);
        commandMap.put(WebSocketMsgType.cs_play, CxMjPlayCommand.class);
    ...
    public static CxMjCommandProcessor getInstance() {
        return processor;
    }
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            CxMjPlayer _player = player.getPlayer(processor);
