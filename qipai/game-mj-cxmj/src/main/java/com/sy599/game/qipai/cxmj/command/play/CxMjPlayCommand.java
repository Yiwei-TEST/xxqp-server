package com.sy599.game.qipai.cxmj.command.play;
...
public class CxMjPlayCommand extends BaseCommand {
    @Override
    public void execute(Player player0, MessageUnit message) throws Exception {
        CxMjPlayer player = (CxMjPlayer) player0;
        ...
        List<CxMj> majiangs = CxMjHelper.toMajiang(majiangIds);
