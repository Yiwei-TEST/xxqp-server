...
public class CxMjTempAction {

    private int seat;// 玩家位置
    private int action;// 玩家所做的操作
    private List<CxMj> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌

    public CxMjTempAction() {
    }

    public CxMjTempAction(int seat, int action, List<CxMj> cardList, List<Integer> hucards) {
        this.seat = seat;
        this.action = action;
        if (cardList == null)
    ...
    public List<CxMj> getCardList() {
        return cardList;
    }

    public void setCardList(List<CxMj> cardList) {
        this.cardList = cardList;
    }
    ...
    public void initData(String data) {
        ...
        cardList = CxMjQipaiTool.explodeMajiang(cardStr, ",");//GuihuziTool.explodeGhz(cardStr, ",");
    ...
    public String buildData() {
        ...
        wrapper.putString(3, StringUtil.implode(CxMjQipaiTool.toMajiangIds(cardList), ","));
