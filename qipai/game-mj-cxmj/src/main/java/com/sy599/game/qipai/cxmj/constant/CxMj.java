...
public enum CxMj {
    ...
    static CxMj[] mjArray;
    public static CxMj[] fullMj = new CxMj[27];
    static {
        init();
    }
    ...
    private static void init() {
        int maxVal = 0;
        for(CxMj mj : CxMj.values()) {
            if (mj.getVal() > maxVal && mj.getId() < 300) {
                maxVal = mj.getVal();
            }
        }
        mjArray = new CxMj[maxVal];
    ...
    public static CxMj getMajang(int id) {
        return CxMj.valueOf(CxMj.class, "mj" + id);
    }
    ...
    public static CxMj getMajiangByValue(int value) {
        for (CxMj mj : CxMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static CxMj getMajiangByVal(int val) {
