package com.sy599.game.qipai.tcdpmj.command;
...
import com.sy599.game.qipai.tcdpmj.command.com.MjComCommand;
import com.sy599.game.qipai.tcdpmj.command.play.MjPlayCommand;
...
public class MjCommandProcessor extends AbstractBaseCommandProcessor {
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            TcdpMjPlayer _player = player.getPlayer(processor);
