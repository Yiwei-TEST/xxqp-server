package com.sy599.game.qipai.tcdpmj.command.play;
...
import com.sy599.game.qipai.tcdpmj.bean.MjDisAction;
...
import com.sy599.game.qipai.tcdpmj.tool.MjHelper;
...
public class MjPlayCommand extends BaseCommand {
    ...
    public void execute(Player player0, MessageUnit message) throws Exception {
        TcdpMjPlayer player = (TcdpMjPlayer) player0;
        ...
        List<TcdpMj> majiangs = MjHelper.toMajiang(majiangIds);
