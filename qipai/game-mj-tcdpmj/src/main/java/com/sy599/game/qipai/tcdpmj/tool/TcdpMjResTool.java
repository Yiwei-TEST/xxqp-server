...
public class TcdpMjResTool {
    public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<TcdpMj> majiangs) {
     ...
     * @return
     */
    public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, TcdpMj majiang) {
        PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
        builder.setAction(0);
        builder.setUserId(player.getUserId() + "");
        builder.setSeat(player.getSeat());
