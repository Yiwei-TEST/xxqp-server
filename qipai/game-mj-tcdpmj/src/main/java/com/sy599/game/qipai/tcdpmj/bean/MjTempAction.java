...
public class MjTempAction {
    ...
    private List<TcdpMj> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌

    public MjTempAction() {
    }

    public MjTempAction(int seat, int action, List<TcdpMj> cardList, List<Integer> hucards) {
        this.seat = seat;
        this.action = action;
        if (cardList == null)
    ...
    public List<TcdpMj> getCardList() {
        return cardList;
    }

    public void setCardList(List<TcdpMj> cardList) {
        this.cardList = cardList;
    }
