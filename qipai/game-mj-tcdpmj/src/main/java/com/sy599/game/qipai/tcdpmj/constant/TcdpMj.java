...
public enum TcdpMj {
    ...
    static TcdpMj[] mjArray;
    public static TcdpMj[] fullMj = new TcdpMj[34];
    static {
        init();
    }
    ...
    private static void init() {
        int maxVal = 0;
        for(TcdpMj mj : TcdpMj.values()) {
            if (mj.getVal() > maxVal && mj.getId() < 300) {
                maxVal = mj.getVal();
            }
        }
        mjArray = new TcdpMj[maxVal];
    ...
    public static TcdpMj getMajang(int id) {
        return TcdpMj.valueOf(TcdpMj.class, "mj" + id);
    }
    ...
    public static TcdpMj getMajiangByValue(int value) {
        for (TcdpMj mj : TcdpMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static TcdpMj getMajiangByVal(int val) {
