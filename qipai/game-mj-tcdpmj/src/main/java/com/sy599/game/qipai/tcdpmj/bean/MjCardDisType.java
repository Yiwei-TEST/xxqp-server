...
import com.sy599.game.qipai.tcdpmj.tool.MjQipaiTool;
...
public class MjCardDisType {
    ...
    public boolean isHasCard(TcdpMj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<TcdpMj> majiangs = MjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = MjQipaiTool.toMajiangVals(majiangs);
    ...
    public boolean isHasCardVal(TcdpMj card) {
        if (cardIds != null) {
            List<TcdpMj> majiangs = MjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = MjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                TcdpMj majiang = TcdpMj.getMajang(id);
