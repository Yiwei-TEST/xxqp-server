...
public class PaohuziCheckCardBean {
	...
	public static final int action_hu=0;
	public static final int action_peng=1;
	public static final int action_zai=2;
	public static final int action_ti=3;
	public static final int action_chi=4;
	public static final int action_pao=5;
