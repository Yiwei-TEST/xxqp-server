...
public class PaohzDisAction {
	/** 出牌 **/
	public static final int action_type_dis_receive = 0;
	/** 胡 **/
	...
	/** 弃胡 **/
	public static final int action_lockhand = 14;
	/** 提龙补牌**/
	public static final int action_buPai= 15;
	/** 打鸟**/
	public static final int action_daniao= 16;
	...
	static {
		...
		actionNameMap.put(action_lockhand, "qihu");
		actionNameMap.put(action_daniao, "daniao");
