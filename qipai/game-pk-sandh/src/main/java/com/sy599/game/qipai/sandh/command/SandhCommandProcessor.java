package com.sy599.game.qipai.sandh.command;

import com.sy599.game.gcommand.BaseCommand;
import com.sy599.game.qipai.AbstractCommandProcessor;
import com.sy599.game.qipai.sandh.bean.SandhPlayer;
import com.sy599.game.qipai.sandh.command.play.SandhComCommand;
import com.sy599.game.qipai.sandh.command.play.PlayCommand;
...
public class SandhCommandProcessor extends AbstractCommandProcessor<SandhPlayer> {
	private static SandhCommandProcessor processor = new SandhCommandProcessor();
	private static Map<Short, Class<? extends BaseCommand<SandhPlayer>>> commandMap = new HashMap<Short, Class<? extends BaseCommand<SandhPlayer>>>();
	private static Map<Class<?>, Short> msgClassToMsgTypeMap = new HashMap<Class<?>, Short>();

	static {
		// commandMap.put(WebSocketMsgType.cs_com, SandhComCommand.class);
...
//		commandMap.put(WebSocketMsgType.cs_com, PdkComCommand.class);
	...
	public static SandhCommandProcessor getInstance() {
		return processor;
	}
	...
	@Override
	public Map<Short, Class<? extends BaseCommand<SandhPlayer>>> loadCommands() {
		return commandMap;
	}
}
