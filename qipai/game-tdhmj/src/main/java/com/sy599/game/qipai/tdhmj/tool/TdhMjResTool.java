...
public class TdhMjResTool {
	public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<TdhMj> majiangs) {
		List<Integer> list = TdhMjHelper.toMajiangIds(majiangs);
	 ...
	 * @return
	 */
	public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, TdhMj majiang) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		builder.setAction(0);
		builder.setUserId(player.getUserId() + "");
		builder.setSeat(player.getSeat());
	...
	public static PlayMajiangRes.Builder buildPlayRes(Player player, int action, List<TdhMj> majiangs) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		List<Integer> list = TdhMjHelper.toMajiangIds(majiangs);
		builder.addAllMajiangIds(list);
		builder.setAction(action);
