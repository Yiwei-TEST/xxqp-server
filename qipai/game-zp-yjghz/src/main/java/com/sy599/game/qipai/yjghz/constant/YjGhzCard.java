...
public enum YjGhzCard {
    ...
    public static YjGhzCard getGuihzCard(List<YjGhzCard> cards, int value) {
    ...
    public static YjGhzCard getGuihzCard(int value) {
        for (YjGhzCard card : YjGhzCard.values()) {
    ...
    public static YjGhzCard getPaohzCard(int id) {
        if (id == 0) {
            return null;
        }
        return YjGhzCard.valueOf(YjGhzCard.class, "phz" + id);
    }
