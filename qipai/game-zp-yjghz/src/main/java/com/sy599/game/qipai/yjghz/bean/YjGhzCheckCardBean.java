 ...
 */
public class YjGhzCheckCardBean {
     ...
     * 胡牌时相关信息
     */
    private YjGhzHuLack lack;
    /**
     * 过掉胡
     */
    private boolean isPassHu;

    public YjGhzCheckCardBean() {
    }

    public YjGhzCheckCardBean(int seat, YjGhzCard disCard) {
        this.seat = seat;
    ...
    public YjGhzCard getDisCard() {
        return disCard;
    }

    public void setDisCard(YjGhzCard disCard) {
        this.disCard = disCard;
    }
    ...
    public YjGhzHuLack getLack() {
        return lack;
    }

    public void setLack(YjGhzHuLack lack) {
        this.lack = lack;
    }
