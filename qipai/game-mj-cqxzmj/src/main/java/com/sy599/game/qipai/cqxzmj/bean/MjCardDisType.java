...
public class MjCardDisType {
    ...
    public boolean isHasCard(CqxzMj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<CqxzMj> majiangs = MjQipaiTool.toMajiang(cardIds);
    ...
    public boolean isHasCardVal(CqxzMj card) {
        if (cardIds != null) {
            List<CqxzMj> majiangs = MjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = MjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                CqxzMj majiang = CqxzMj.getMajang(id);
