package com.sy599.game.qipai.cqxzmj.command;
...
import com.sy599.game.qipai.cqxzmj.command.com.MjComCommand;
import com.sy599.game.qipai.cqxzmj.command.play.MjPlayCommand;
...
public class MjCommandProcessor extends AbstractBaseCommandProcessor {
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            CqxzMjPlayer _player = player.getPlayer(processor);
