...
//
        ...
        desk=  Arrays.asList(313,213,113,312,212,112,409,208);
        List<Integer> myout = new ArrayList<>();
        myout = Arrays.asList(415, 408, 404, 304, 204, 403, 203, 303);
        System.out.println("==>");
        System.out.println(canChuPai(desk,myout,"fjddan","fjddan"));
