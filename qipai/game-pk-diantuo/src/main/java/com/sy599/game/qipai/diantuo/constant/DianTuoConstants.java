package com.sy599.game.qipai.diantuo.constant;
...
public class DianTuoConstants {

	/*** 桌状态选独战 */
    public static final int TABLE_STATUS_DUZHAN = 1;
...
//    public static final int TABLE_DINGZHUANG = 7;
    ...
    /**不要*/
    public static final int BU_YAO=1;
    /**要不起*/
    public static final int YAO_BUQI=2;
    
    /**吃分*/
    public static final int ZHUO_FEN=3;
