...
public class XplpTempAction {

    private int seat;// 玩家位置
    private int action;// 玩家所做的操作
    private List<XpLp> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌

    public XplpTempAction() {
    }

    public XplpTempAction(int seat, int action, List<XpLp> cardList, List<Integer> hucards) {
        this.seat = seat;
        this.action = action;
        if (cardList == null)
    ...
    public List<XpLp> getCardList() {
        return cardList;
    }

    public void setCardList(List<XpLp> cardList) {
        this.cardList = cardList;
    }
    ...
    public void initData(String data) {
        ...
        cardList = XplpQipaiTool.explodeMajiang(cardStr, ",");//GuihuziTool.explodeGhz(cardStr, ",");
    ...
    public String buildData() {
        ...
        wrapper.putString(3, StringUtil.implode(XplpQipaiTool.toMajiangIds(cardList), ","));
