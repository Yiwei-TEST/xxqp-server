...
public class XplpCardDisType {
    ...
    public boolean isHasCard(XpLp card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<XpLp> majiangs = XplpQipaiTool.toMajiang(cardIds);
            List<Integer> vals = XplpQipaiTool.toMajiangVals(majiangs);
    ...
    public boolean isHasCardVal(XpLp card) {
        if (cardIds != null) {
            List<XpLp> majiangs = XplpQipaiTool.toMajiang(cardIds);
            List<Integer> vals = XplpQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                XpLp majiang = XpLp.getMajang(id);
