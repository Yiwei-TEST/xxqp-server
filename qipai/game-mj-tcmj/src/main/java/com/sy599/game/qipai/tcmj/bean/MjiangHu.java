...
//            //跟庄+1
     ...
     * @date 2019/9/2
     */
    public static int calcMenZiScore(TcMjTable table, List<Integer> menZiSrc) {
     ...
     * @date 2019/9/2
     */
    public static int calcMenZiScore(TcMjTable table, List<Integer> menZiSrc, int basic) {
