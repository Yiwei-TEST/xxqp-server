...
//            calcSpecialMenZi(lastWinSeat);
            ...
            if (selfMo && !qiangGangHu) {
                ...
                LogUtil.printDebug("计算门子得分:{}, {}, 飄分{}, 基礎分:{}", winScore, MjTool.dahuListToString(winPlayer.getDahu()), winPlayer.getFlutterVal(), gameModel.getBasicScore());
                ...
                for (int winnerSeat : winSeatList) {
                    ...
                    LogUtil.printDebug("得分:{}, 飘分:{}", lossTotalSubScore, losePlayer.getFlutterVal());
