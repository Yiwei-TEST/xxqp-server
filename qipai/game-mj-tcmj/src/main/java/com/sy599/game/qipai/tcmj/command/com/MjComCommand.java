package com.sy599.game.qipai.tcmj.command.com;
...
public class MjComCommand extends BaseCommand<TcMjPlayer> {
    ...
    @Override
    public void execute(TcMjPlayer player, MessageUnit message) throws Exception {
        ComReq req = null;
        try {
