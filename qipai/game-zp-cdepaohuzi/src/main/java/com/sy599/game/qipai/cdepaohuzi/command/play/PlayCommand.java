package com.sy599.game.qipai.cdepaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<CdePaohuziPlayer> {

    @Override
    public void execute(CdePaohuziPlayer player, MessageUnit message) throws Exception {
