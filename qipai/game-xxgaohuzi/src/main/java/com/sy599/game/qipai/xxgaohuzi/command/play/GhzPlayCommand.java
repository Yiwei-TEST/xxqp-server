package com.sy599.game.qipai.xxgaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class GhzPlayCommand extends BaseCommand<XxGaohuziPlayer> {

    @Override
    public void execute(XxGaohuziPlayer player, MessageUnit message) throws Exception {
