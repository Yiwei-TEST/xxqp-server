package com.sy599.game.qipai.xxgaohuzi.tool;

import com.sy599.game.GameServerConfig;
import com.sy599.game.qipai.xxgaohuzi.bean.GameModel;
import com.sy599.game.qipai.xxgaohuzi.bean.PaohuziHandCard;
import com.sy599.game.qipai.xxgaohuzi.bean.PaohuziHuBean;
...
//    }
    ...
    public static PaohuziHuLack isHuNew(PaohuziHandCard handCardBean, PaohzCard disCard, boolean isSelfMo, int outCardHuxi, boolean needDui, boolean isPaoHu, GameModel gameModel) {
        ...
        //这里手牌为0时,视为没有手牌了,如果是需要对子的牌型,这种情况不能胡
        if (handPais.size() == 0) {
            lack.setHu(!needDui);
        } else {
            sortMin(handPais);
