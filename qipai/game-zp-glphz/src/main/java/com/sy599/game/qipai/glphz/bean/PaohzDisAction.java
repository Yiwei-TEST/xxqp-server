...
public class PaohzDisAction {
	...
	/**摸鬼 **/
	public static final int action_mogui = 14;
	/** 提龙补牌**/
	public static final int action_buPai= 15;
	/** 桂林字牌自摸 **/
	public static final int action_zimo= 16;
	/** 桂林字牌放炮 **/
	public static final int action_fangpao= 17;
	...
	static {
		...
		actionNameMap.put(action_mogui, "mogui");
	}
