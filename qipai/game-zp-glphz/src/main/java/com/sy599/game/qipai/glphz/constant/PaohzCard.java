package com.sy599.game.qipai.glphz.constant;
...
public enum PaohzCard {
	...
	phzf1(-1, 1), phzf2(-2, 2), phzf3(-3, 3), phzf4(-4, 4), phzf5(-5, 5), phzf6(-6, 6), 
	phzf7(-7, 7),phzf8(-8, 8), phzf9(-9, 9), phzf10(-10, 10),
	phzf11(-41, 101), phzf12(-42, 102), phzf13(-43, 103), phzf14(-44, 104), phzf15(-45, 105), 
	phzf16(-46, 106), phzf17(-47, 107), phzf18(-48, 108), phzf19(-49, 109), phzf20(-50, 110)
	
	;
	private int id;
	private int val;

	public static List<PaohzCard> huCardList = new ArrayList<>(
			Arrays.asList(phzf1,phzf2,phzf3,phzf4,phzf5,phzf6,phzf7,phzf8,phzf9,phzf10,
					phzf11,phzf12,phzf13,phzf14,phzf15,phzf16,phzf17,phzf18,phzf19,phzf20));

	
	public static int getIdByHucardVal(int val){
	...
	public static Integer getNextCardVal(int val){
		if (val == 0) {
			return 0;
		}
		if(val == 1){
	...
	public static Integer getLastCardVal(int val){
		if (val == 0) {
			return 0;
		}
		if(val == 10){
