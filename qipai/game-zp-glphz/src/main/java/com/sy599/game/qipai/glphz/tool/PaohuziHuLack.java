...
public class PaohuziHuLack implements Cloneable {
	...
	private int huxi;
	private int guixing;//胡鬼牌的时候的醒
	private int guihuanCard;//鬼牌替换成了什么牌
	...
	public int getGuixing() {
		return guixing;
	}

	public void setGuixing(int guixing) {
		this.guixing = guixing;
	}

	public int getGuihuanCard() {
		return guihuanCard;
	}

	public void setGuihuanCard(int guihuanCard) {
		this.guihuanCard = guihuanCard;
	}
