package com.sy599.game.qipai.hyshk.rule;


import com.sy599.game.qipai.hyshk.been.CardTypeHuxi;
...
public class PaohuziMingTangRule {
	 ...
	 * @return
	 */
	public static List<Integer> calcMingTang(HyshkPlayer player, PaohuziHuLack hu,HyshkTable table){
	...
	public static int countXiTun(int tun, List<Integer> mts,HyshkTable table) {
