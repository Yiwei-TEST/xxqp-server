...
public class ZzMjCardDisType {
    ...
    public boolean isHasCard(ZzMj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<ZzMj> majiangs = ZzMjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = ZzMjQipaiTool.toMajiangVals(majiangs);
    ...
    public boolean isHasCardVal(ZzMj card) {
        if (cardIds != null) {
            List<ZzMj> majiangs = ZzMjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = ZzMjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                ZzMj majiang = ZzMj.getMajang(id);
