...
public enum ZzMj {
    ...
    static ZzMj[] mjArray;
    public static ZzMj[] fullMj = new ZzMj[27];
    static {
        init();
    }
    ...
    public static ZzMj getMajang(int id) {
        return ZzMj.valueOf(ZzMj.class, "mj" + id);
    }
    ...
    public static ZzMj getMajiangByValue(int value) {
        for (ZzMj mj : ZzMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static ZzMj getMajiangByVal(int val) {
