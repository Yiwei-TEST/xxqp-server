...
public class YzwdmjCardDisType {
    private int action;
    ...
    public boolean isHasCard(Yzwdmj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<Yzwdmj> majiangs = YzwdmjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = YzwdmjQipaiTool.toMajiangVals(majiangs);
    ...
    public boolean isHasCardVal(Yzwdmj card) {
        if (cardIds != null) {
            List<Yzwdmj> majiangs = YzwdmjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = YzwdmjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                Yzwdmj majiang = Yzwdmj.getMajang(id);
