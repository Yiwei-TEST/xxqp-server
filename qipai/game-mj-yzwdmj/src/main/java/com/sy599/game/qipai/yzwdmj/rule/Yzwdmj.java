...
public enum Yzwdmj {
    ...
    static Yzwdmj[] mjArray;
    public static Yzwdmj[] fullMj = new Yzwdmj[27];
    static {
        init();
    }
    ...
    public static Yzwdmj getMajang(int id) {
        return Yzwdmj.valueOf(Yzwdmj.class, "mj" + id);
    }
    ...
    public static Yzwdmj getMajiangByValue(int value) {
        for (Yzwdmj mj : Yzwdmj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static Yzwdmj getMajiangByVal(int val) {
     ...
     * @return
     */
    public static List<Integer> toPhzCardIds(List<Yzwdmj> mjs) {
        if (mjs == null) {
            return Collections.emptyList();
        }

        List<Integer> ids = new ArrayList<>(mjs.size());
        for (Yzwdmj phz : mjs) {
            ids.add(phz.getId());
        }
        return ids;
     ...
     * @return
     */
    public static List<Integer> toPhzCardVals(List<Integer> mjs) {
        if (mjs == null) {
            return Collections.emptyList();
        }
        List<Integer> vals = new ArrayList<>(mjs.size());
        for (Integer id : mjs) {
            vals.add(Yzwdmj.getMajang(id).getVal());
        }
        return vals;
    }
}
