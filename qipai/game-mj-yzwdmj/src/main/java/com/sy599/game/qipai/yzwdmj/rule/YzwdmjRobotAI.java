 ...
 * @date 2012-12-3
 */
public class YzwdmjRobotAI {

    private static YzwdmjRobotAI robotAI;

    public static YzwdmjRobotAI getInstance() {
        if (robotAI == null) {
            robotAI = new YzwdmjRobotAI();
        }
        return robotAI;
    }
