...
public class YzwdmjDisAction {
    ...
    public static final int action_mo = 1000;
    public static final int action_passmo = 2;

    /*
    王闯
     */
    public static final int action_wangchuang = 1101;
    /*
    王钓
     */
    public static final int action_wangdiao = 1102;
    /**
     * 优先list
     **/
