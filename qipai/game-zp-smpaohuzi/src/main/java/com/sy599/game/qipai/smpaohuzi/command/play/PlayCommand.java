package com.sy599.game.qipai.smpaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<SmPaohuziPlayer> {

    @Override
    public void execute(SmPaohuziPlayer player, MessageUnit message) throws Exception {
