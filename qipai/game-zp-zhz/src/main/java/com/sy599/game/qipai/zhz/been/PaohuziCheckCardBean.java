...
public class PaohuziCheckCardBean {
	...
	public static final int act_hu=0;
	public static final int act_peng=1;
	public static final int act_zai=2;
	public static final int act_ti=3;
	public static final int act_chi=4;
	public static final int act_pao=5;
