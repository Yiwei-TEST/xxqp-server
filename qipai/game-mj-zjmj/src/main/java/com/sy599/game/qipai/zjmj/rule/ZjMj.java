...
public enum ZjMj {
    ...
    static ZjMj[] mjArray;
    public static ZjMj[] fullMj = new ZjMj[27];
...
//                }
    ...
    public static ZjMj getMajang(int id) {
        return ZjMj.valueOf(ZjMj.class, "mj" + id);
    }
    ...
    public static ZjMj getMajiangByVal(int val) {
