package com.sy599.game.qipai.zjmj.command.play;
...
import com.sy599.game.qipai.zjmj.bean.ZjMjDisAction;
...
public class ZjMjPlayCommand extends BaseCommand {
	@Override
	public void execute(Player player0, MessageUnit message) throws Exception {
		ZjMjPlayer player = (ZjMjPlayer) player0;
		...
		List<ZjMj> majiangs = ZjMjHelper.toMajiang(majiangIds);
