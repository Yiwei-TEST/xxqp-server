...
public class ZjMjDisAction {
	...
	/** 摇杠**/
	public static final int action_yaogang= 14;
	/** 摇杠**/
	public static final int action_yaoangang= 15;
	...
	/** 优先list **/
	public static final List<Integer> priority_action = Arrays.asList(action_hu, action_angang, action_yaogang,action_minggang, action_buzhang, action_peng, action_chi);
	...
	public static List<Integer> parseToDisActionList(List<Integer> actionList) {
		...
		if (actionList.get(6) == 1) {
			disActionList.add(action_yaogang);
		}
		return disActionList;
	}
