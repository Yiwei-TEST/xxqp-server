...
//	}
	 ...
	 * @return
	 */
	public static ZjMj getMajiangByVal(List<ZjMj> majiangs, int majiangVal) {
		for (ZjMj majiang : majiangs) {
			if (majiang.getVal() == majiangVal) {
				return majiang;
			}
	 ...
	 * @return
	 */
	public static ZjMj getMajiangById(List<ZjMj> majiangs, int majiangId) {
		for (ZjMj majiang : majiangs) {
			if (majiang.getId() == majiangId) {
				return majiang;
			}
		}
		return null;
	...
	public static List<ZjMj> find(List<Integer> copy, List<Integer> valList) {
		...
		if (!valList.isEmpty()) {
			for (int zpId : valList) {
				...
				while (iterator.hasNext()) {
					...
					ZjMj majiang = ZjMj.getMajang(card);
