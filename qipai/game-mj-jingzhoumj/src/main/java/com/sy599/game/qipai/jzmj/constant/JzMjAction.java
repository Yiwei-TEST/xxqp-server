...
//    public static final int BUZHANG = 5;
    /***2020年5月22日10:38:27 靖州去补转杠操作 */
    public static final int BUZHANG = 2;
...
//    public static final int BUZHANG_AN = 16;
    /*** 2020年5月22日10:39:28 暗杠补张转杠*/
    public static final int BUZHANG_AN = 3;
    /*** 自摸*/
    ...
    public static boolean hasHu(List<Integer> actionList) {
        return hasAction(actionList, JzMjAction.HU) || hasAction(actionList,ZIMO);
    }
    ...
    public static boolean hasGang(List<Integer> actionList) {
        return hasAction(actionList, JzMjAction.MINGGANG);
    }
