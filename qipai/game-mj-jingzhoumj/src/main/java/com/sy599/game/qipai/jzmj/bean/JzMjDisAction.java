...
public class JzMjDisAction {
	...
	/** 接杠 **/
	public static final int action_jiegang = 15;
	/** pass **/
	...
	/** 报听 **/
	public static final int action_baoting = 25;

	/** 优先list **/
	public static final List<Integer> priority_action = Arrays.asList(action_xiaohu,action_baoting, action_hu, action_angang, action_minggang, action_buzhang,action_buzhang_an, action_peng, action_layEgg, action_chi);
	...
	public static List<Integer> parseToDisActionList(List<Integer> actionList) {
		...
		for(int action = 6; action < JzMjAction.ACTION_SIZE; action ++) {
