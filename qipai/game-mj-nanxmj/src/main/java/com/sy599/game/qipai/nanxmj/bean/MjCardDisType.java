...
import com.sy599.game.qipai.nanxmj.tool.MjQipaiTool;
...
public class MjCardDisType {
    ...
    public boolean isHasCard(NxMj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<NxMj> majiangs = MjQipaiTool.toMajiang(cardIds);
    ...
    public boolean isHasCardVal(NxMj card) {
        if (cardIds != null) {
            List<NxMj> majiangs = MjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = MjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                NxMj majiang = NxMj.getMajang(id);
