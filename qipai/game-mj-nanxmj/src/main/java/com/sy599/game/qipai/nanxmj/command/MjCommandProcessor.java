package com.sy599.game.qipai.nanxmj.command;
...
import com.sy599.game.qipai.nanxmj.command.com.MjComCommand;
import com.sy599.game.qipai.nanxmj.command.play.MjPlayCommand;
...
public class MjCommandProcessor extends AbstractBaseCommandProcessor {
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            NanxMjPlayer _player = player.getPlayer(processor);
