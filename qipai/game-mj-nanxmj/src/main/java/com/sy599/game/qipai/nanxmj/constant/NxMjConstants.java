package com.sy599.game.qipai.nanxmj.constant;
...
//    public static final int ACTION_INDEX_BAOTING = 6;
    ...
    public static List<Integer> mjList = new ArrayList<>();
    public static List<Integer> mj_cymList = new ArrayList<>();
    ...
    static {
        ...
        // ///////////////////////
        for (int i = 1; i <= 108; i++) {
            int chu = NxMj.getMajang(i).getVal()/10;
            if(chu==2)
                continue;
            mj_cymList.add(i);
        }
...
//        }
    ...
    public static List<Integer> getMajiangList() {
        return new ArrayList<>(mjList);
    }


    public static List<Integer> getListChouYiMen() {
        return new ArrayList<>(mj_cymList);
    }
}
