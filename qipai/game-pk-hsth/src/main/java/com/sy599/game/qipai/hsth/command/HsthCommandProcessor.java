package com.sy599.game.qipai.hsth.command;

import com.sy599.game.gcommand.BaseCommand;
import com.sy599.game.qipai.AbstractCommandProcessor;
import com.sy599.game.qipai.hsth.bean.HsthPlayer;
import com.sy599.game.qipai.hsth.command.play.HsthComCommand;
import com.sy599.game.qipai.hsth.command.play.HsthPlayCommand;
...
public class HsthCommandProcessor extends AbstractCommandProcessor<HsthPlayer> {
	private static HsthCommandProcessor processor = new HsthCommandProcessor();
	private static Map<Short, Class<? extends BaseCommand<HsthPlayer>>> commandMap = new HashMap<Short, Class<? extends BaseCommand<HsthPlayer>>>();
	...
	static {
		...
		commandMap.put(WebSocketMsgType.cs_play, HsthPlayCommand.class);
		commandMap.put(WebSocketMsgType.cs_com, HsthComCommand.class);
//		commandMap.put(WebSocketMsgType.cs_com, PdkComCommand.class);
	...
	public static HsthCommandProcessor getInstance() {
		return processor;
	}
	...
	@Override
	public Map<Short, Class<? extends BaseCommand<HsthPlayer>>> loadCommands() {
		return commandMap;
	}
}
