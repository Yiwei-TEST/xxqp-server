			...
			for (String paii :ts ) {
			   ...
			   if(zjp.contains(replace_B)){
				...
				if(zjp.contains(replace_R)){
					List<String> l = copyList(ts);
					l.remove(paii);
					l.add(replace_B);   sortList(l,"asc");
					if(!isHave(l, allts)) {
						allts.add(l);
					}
				}
...
//		}
		...
		sjp1.add("F3");sjp1.add("F3");sjp1.add("F3");sjp1.add("F3");
...
//		}
	...
	public static List<List<String>> getTsZhaDan(List<String> sjp, List<String> zjp, String type) {
		...
		if(type.equals("min50k")) {
			...
			List<String> zjp1 = new ArrayList<String>();
			zjp1.addAll(zjp);
			sjp1.add("F3");sjp1.add("F3");sjp1.add("F3");sjp1.add("F3");sjp1.add("F4");sjp1.add("F4");sjp1.add("F4");sjp1.add("F4");
			List<List<String>> _8zhaList = getTs8zha(sjp1, zjp1);
			//将8炸里出现的牌remove掉
			for(List<String> list : _8zhaList) {
				for(String pai : list) {
...
//			 }
	 ...
	 * @return
	 */
	public static String getCpType2(List<String> pai,int painum) {
	 ...
	 *
	 * @param pai
	 * @return 1=单；2=对子 ;3=三张 ；4 =炸弹 ；5= 同花
	 */
	public static int getCpIntType(List<String> pai,int pai_num) {
		if(null==pai || pai.size()==0){
			return 0;
		}
		int type = 0;
	 ...
	 * @return
	 */
	private static  boolean isTongHuaBoom(List<String> pai,int pai_num){
		boolean isboom = true;
		if(pai.size()<4 && pai_num<10){
			isboom= false;
			return false;
		}
		if(pai.size()<=4 && pai_num>=10){
	...
	private static boolean isBoomm(List<String> pai) {
		boolean isboom = true;
		if(pai.size()<4){
			isboom= false;
			return false;
		}else{
			int num = getNumbers(pai.get(0));
			for (String p : pai) {
				if(num!=getNumbers(p)){
					isboom= false;
					return false;
...
//		all.addAll(_3wList);
    ...
    public static List<List<String>> getTsLianDuiNew(List<String> sjp, List<String> zjp) {
		...
		List<String> zjp1 = new ArrayList<String>();
		zjp1.addAll(zjp);
		sjp1.add("F3");sjp1.add("F3");sjp1.add("F4");sjp1.add("F4");
		List<List<String>> _8zhaList = getTs8zha(sjp1, zjp1);
		//将8炸里出现的牌remove掉
		for(List<String> list : _8zhaList) {
			for(String pai : list) {
...
//		all.addAll(_3wList);
    ...
    public static List<List<String>> getTsLian3zhangNew(List<String> sjp, List<String> zjp) {
		...
		List<String> zjp1 = new ArrayList<String>();
		zjp1.addAll(zjp);
		sjp1.add("F3");sjp1.add("F3");sjp1.add("F3");sjp1.add("F4");sjp1.add("F4");sjp1.add("F4");
		List<List<String>> _8zhaList = getTs8zha(sjp1, zjp1);
		//将8炸里出现的牌remove掉
		for(List<String> list : _8zhaList) {
			for(String pai : list) {
