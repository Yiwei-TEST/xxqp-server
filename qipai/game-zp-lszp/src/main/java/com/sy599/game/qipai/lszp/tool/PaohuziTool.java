package com.sy599.game.qipai.lszp.tool;

import com.alibaba.fastjson.JSON;
import com.sy599.game.GameServerConfig;

import com.sy599.game.qipai.lszp.been.CardTypeHuxi;
import com.sy599.game.qipai.lszp.been.PaohuziHandCard;
import com.sy599.game.qipai.lszp.been.PaohuziHuBean;
import com.sy599.game.qipai.lszp.been.PaohzDisAction;
...
//				lack.addPhzHuCards(PaohzDisAction.action_zai, toPhzCardIds(cards), huxi);
    ...
    public static void main(String[] args) {
        ...
        valList = new ArrayList<>(Arrays.asList(101, 102, 103, 104, 104));needDui = true;
        valList = new ArrayList<>(Arrays.asList(1, 1, 1, 4, 4, 4, 7, 7, 7, 10, 10, 101, 102, 103, 106, 107, 108, 109, 110, 110, 105));needDui = false;
