package com.sy599.game.qipai.chaosmj.tool;
...
import com.sy599.game.qipai.chaosmj.rule.MjIndex;
import com.sy599.game.qipai.chaosmj.rule.MjIndexArr;
...
//	}
     ...
     */
    public static MjiangHu isHu(List<Mj> handCardIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, boolean isbegin, boolean jiang258, Mj huMj, ChaosMjTable table, ChaosMjPlayer player) {
     ...
     * @date 2019/10/16
     */
    public static MjiangHu isHu(List<Mj> handCardIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, boolean isBegin, boolean jiang258, ChaosMjTable table, Mj huMj, ChaosMjPlayer player, boolean onlyYingZhuangHu) {
...
//        LogUtil.printDebug("胡牌检测, 胡:{}, 大胡:{}, 地地胡需要牌:{}", hu.isHu(), dahuListToString(hu.getDahuList()), table.getGameModel().getSpecialPlay().getFloorHuNum() + 1);
     ...
     *@date 2019/10/22
     */
    private static void isHuMain(List<Mj> handCardIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, boolean jiang258, ChaosMjTable table, ChaosMjPlayer player, MjiangHu hu, boolean canYingZhuang) {
...
//        }
     ...
     * @return
     */
    public static List<Mj> getTingMjs(List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, boolean jiang258, boolean dahu, int rule, ChaosMjTable table, ChaosMjPlayer player) {
...
//                LogUtil.printDebug("拆牌后, 胡牌检测通过:{}"+JacksonUtil.writeValueAsString(lack));
    ...
    public static List<Mj> checkChi(List<Mj> majiangs, Mj dismajiang , ChaosMjTable table) {
...
//		pais = "32,32,33,33,34,15,15,21,21,22,22,24,24,36";
        ...
        ChaosMjTable tjMjTable = new ChaosMjTable();
