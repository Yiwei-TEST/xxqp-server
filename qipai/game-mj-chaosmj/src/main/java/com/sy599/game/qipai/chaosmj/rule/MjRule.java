...
import com.sy599.game.qipai.chaosmj.bean.*;
...
public class MjRule {
	 ...
	 *
	 */
	public static void checkXiaoHu3(MjiangHu hu, List<Mj> majiangIds, boolean begin, ChaosMjTable table) {
		int playerNum = 4;
		if (table != null) {
	 ...
	 *
	 */
	public static void checkXiaoHu2(MjiangHu hu, List<Mj> majiangIds, boolean begin, ChaosMjTable table, ChaosMjPlayer player) {
		int playerNum = 4;
		if (table != null) {
			playerNum = table.getMaxPlayerCount();
		}
	 ...
	 * @return
	 */
	public static void checkDahu(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, boolean canYingZhuang, ChaosMjPlayer player) {
...
//				}
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkShiSanYao(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, ChaosMjPlayer player, Mj kingCard, int curkingCardNum) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkHunYiSe(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, ChaosMjPlayer player, Mj kingCard, int curkingCardNum, List<Mj> allMajiangs) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkZiYiSe(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, ChaosMjPlayer player, Mj kingCard, int curkingCardNum, List<Mj> allMajiangs) {
		if (table.getGameModel().isNoneChar() || (hu.getDahuCount() <= 0 && !hu.isHu())) {
			return false;
		}
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkShiBaLuoHan(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, ChaosMjPlayer player, Mj kingCard, int curkingCardNum) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkYiJiuHu(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, ChaosMjPlayer player, Mj kingCard, int curkingCardNum, MjIndexArr all_card_index) {
	 ...
	 * @date 2019/11/12
	 */
	public static boolean checkQingYiJiu(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, List<Mj> peng, List<Mj> chi, List<Mj> buzhang, ChaosMjTable table, ChaosMjPlayer player, Mj kingCard, int curkingCardNum, MjIndexArr all_card_index) {
	 ...
	 *@date 2019/10/29
	 */
	private static boolean check7Dui(MjiangHu hu, List<Mj> majiangIds, List<Mj> gang, ChaosMjTable table, Mj kingCard, boolean existsEat, List<Mj> peng) {
