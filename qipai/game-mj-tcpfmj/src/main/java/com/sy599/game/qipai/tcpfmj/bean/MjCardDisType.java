...
import com.sy599.game.qipai.tcpfmj.tool.MjQipaiTool;
...
public class MjCardDisType {
    ...
    public boolean isHasCard(TcpfMj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<TcpfMj> majiangs = MjQipaiTool.toMajiang(cardIds);
    ...
    public boolean isHasCardVal(TcpfMj card) {
        if (cardIds != null) {
            List<TcpfMj> majiangs = MjQipaiTool.toMajiang(cardIds);
            List<Integer> vals = MjQipaiTool.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                TcpfMj majiang = TcpfMj.getMajang(id);
