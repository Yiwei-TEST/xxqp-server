package com.sy599.game.qipai.tcpfmj.command.play;
...
import com.sy599.game.qipai.tcpfmj.bean.MjDisAction;
...
import com.sy599.game.qipai.tcpfmj.tool.MjHelper;
...
public class MjPlayCommand extends BaseCommand {
    ...
    public void execute(Player player0, MessageUnit message) throws Exception {
        TcpfMjPlayer player = (TcpfMjPlayer) player0;
        ...
        List<TcpfMj> majiangs = MjHelper.toMajiang(majiangIds);
