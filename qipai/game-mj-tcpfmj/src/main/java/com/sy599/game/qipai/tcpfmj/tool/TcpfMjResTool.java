...
public class TcpfMjResTool {
    public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<TcpfMj> majiangs) {
     ...
     * @return
     */
    public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, TcpfMj majiang) {
        PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
        builder.setAction(0);
        builder.setUserId(player.getUserId() + "");
        builder.setSeat(player.getSeat());
