package com.sy599.game.qipai.tcpfmj.constant;
...
public enum TcpfMj {
    ...
    static TcpfMj[] mjArray;
    public static TcpfMj[] fullMj = new TcpfMj[34];
    static {
        init();
    }
    ...
    private static void init() {
        int maxVal = 0;
        for(TcpfMj mj : TcpfMj.values()) {
            if (mj.getVal() > maxVal && mj.getId() < 300) {
                maxVal = mj.getVal();
            }
        }
        mjArray = new TcpfMj[maxVal];
    ...
    public static TcpfMj getMajang(int id) {
        return TcpfMj.valueOf(TcpfMj.class, "mj" + id);
    }
    ...
    public static TcpfMj getMajiangByValue(int value) {
        for (TcpfMj mj : TcpfMj.values()) {
            if (mj.getVal() == value) {
                return mj;
            }
    ...
    public static TcpfMj getMajiangByVal(int val) {
