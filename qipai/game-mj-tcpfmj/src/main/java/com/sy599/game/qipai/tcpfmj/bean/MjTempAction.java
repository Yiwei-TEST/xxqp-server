...
public class MjTempAction {
    ...
    private List<TcpfMj> cardList;// 操作对应的牌
    private List<Integer> hucards;// 报听胡的牌

    public MjTempAction() {
    }

    public MjTempAction(int seat, int action, List<TcpfMj> cardList, List<Integer> hucards) {
        this.seat = seat;
        this.action = action;
        if (cardList == null)
    ...
    public List<TcpfMj> getCardList() {
        return cardList;
    }

    public void setCardList(List<TcpfMj> cardList) {
        this.cardList = cardList;
    }
