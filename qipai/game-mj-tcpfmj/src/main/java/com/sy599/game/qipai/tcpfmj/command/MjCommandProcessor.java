package com.sy599.game.qipai.tcpfmj.command;
...
import com.sy599.game.qipai.tcpfmj.command.com.MjComCommand;
import com.sy599.game.qipai.tcpfmj.command.play.MjPlayCommand;
...
public class MjCommandProcessor extends AbstractBaseCommandProcessor {
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            TcpfMjPlayer _player = player.getPlayer(processor);
