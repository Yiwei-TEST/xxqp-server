package com.sy599.game.qipai.xtpaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<XtPaohuziPlayer> {

    @Override
    public void execute(XtPaohuziPlayer player, MessageUnit message) throws Exception {
