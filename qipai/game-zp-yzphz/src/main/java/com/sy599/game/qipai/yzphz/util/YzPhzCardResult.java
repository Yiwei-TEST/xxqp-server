...
public class YzPhzCardResult {
    ...
    public void setReplaceCards( List<Integer> replaceCardslist) {
        List<String> a = new ArrayList<>();
        for (Integer i:replaceCardslist
             ) {
...
//                }
    ...
    public String toString() {
        return "YzPhzCardResult{" +
                "canHu=" + canHu +
                ", curId=" + curId +
                ", 总胡息totalHuxi=" + totalHuxi +
                ", redTotal=" + redTotal +
                ", redCount=" + redCount +
                ", handCards=" + handCards +
                ", self=" + self +
                ", wangDiao=" + wangDiao +
                ", wangChuang=" + wangChuang +
                ", wangZha=" + wangZha +
                ", fans=" + fans +
                ", phzBase=" + phzBase +
                ", xingCard=" + xingCard +
                ...
                ", huxiTun=" + huxiTun +
                ", xingTun=" + xingTun +
                ", cardMessageList=" + cardMessageList.toString() +
                ", replaceCards=" + replaceCards.toString() +
                ", checkCmMap=" + checkCmMap.toString() +
//                ", chuangCardResult=" +chuangCardResult==null?"": chuangCardResult.toString() +
//                ", diaoCardResult=" + diaoCardResult==null?"":diaoCardResult.toString() +
//                ", wangCardMessage=" + wangCardMessage==null?"":wangCardMessage.toString() +
                '}';
    }
}
