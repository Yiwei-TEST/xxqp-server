...
public enum YzPhzHuXiEnums {
    ...
    YzPhzHuXiEnums(int action, int big, int small) {
        this.action = action;
        this.big = big;
        this.small = small;
    }
     ...
     * @return
     */
    public final static boolean isChi(YzPhzHuXiEnums huXiEnums) {
     ...
     * @return
     */
    public final static boolean isChi0(YzPhzHuXiEnums huXiEnums) {
