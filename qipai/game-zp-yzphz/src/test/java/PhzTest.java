...
public class PhzTest {
    public static void main(String[] args) {
        YzPhzHandCards handCards = new YzPhzHandCards(Arrays.asList(1,11,51,61,63,2,3,4,14,54,64,55,65,75,7,57,67,60,59,58));
...
//        handCards.CHI_COMMON.add(Arrays.asList(18,19,20));
        ...
        YzPhzBase phzBase = new YzPhzBase() {
            @Override
        ...
        YzPhzCardResult cardResult = YzPhzHuPaiUtils.huPai(handCards,52,phzBase,true,"test",52);
