...
public class PaohzDisAction {
	...
	/** 啫 **/
	public static final int action_shi = 4;
	/** pass **/
...
//	public static final int action_pao = 7;
	...
	/** 优先list ------提，栽，胡，跑，碰，吃 **///action_ti,, action_pao
	public static final List<Integer> priority_action = Arrays.asList( action_zai, action_chouzai, action_hu, action_peng, action_chi);
	// 0胡 1碰 2栽 3提 4吃 5跑
	// ////////////////////////////////////////////////////////
	/** 动作 **/
    ...
    public static List<Integer> keepHu(List<Integer> actionList) {
        if (actionList == null || actionList.size() < action_hu) {
