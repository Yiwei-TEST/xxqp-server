package com.sy599.game.qipai.axphz254.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<AxPaohuziPlayer> {

    @Override
    public void execute(AxPaohuziPlayer player, MessageUnit message) throws Exception {
