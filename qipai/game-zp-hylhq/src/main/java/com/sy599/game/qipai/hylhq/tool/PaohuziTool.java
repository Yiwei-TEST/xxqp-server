package com.sy599.game.qipai.hylhq.tool;

import com.alibaba.fastjson.JSON;
import com.sy599.game.GameServerConfig;

import com.sy599.game.qipai.hylhq.been.*;
...
public class PaohuziTool {
                ...
                for (Integer val : duiZi.getPaohzValMap().keySet()) {
                    ...
                    if (handPaisCopy.size() == 0) {
                        ...
                        if (disCard != null && disCard.getVal() == val) {
                            chaiPaiNew(huList, newLack, handPaisCopy, null,have1510);
                        } else {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("手牌数"+counts[0]);
