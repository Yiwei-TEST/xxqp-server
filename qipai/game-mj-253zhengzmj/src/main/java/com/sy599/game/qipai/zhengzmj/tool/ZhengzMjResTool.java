...
public class ZhengzMjResTool {
	public static void buildPlayRes(PlayMajiangRes.Builder builder, Player player, int action, List<ZhengzMj> majiangs) {
		List<Integer> list = ZhengzMjHelper.toMajiangIds(majiangs);
	 ...
	 * @return
	 */
	public static PlayMajiangRes.Builder buildDisMajiangRes(Player player, ZhengzMj majiang) {
		PlayMajiangRes.Builder builder = PlayMajiangRes.newBuilder();
		builder.setAction(0);
		builder.setUserId(player.getUserId() + "");
		builder.setSeat(player.getSeat());
