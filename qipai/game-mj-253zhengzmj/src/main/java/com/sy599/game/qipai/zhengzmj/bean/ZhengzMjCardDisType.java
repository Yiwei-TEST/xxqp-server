...
public class ZhengzMjCardDisType {
	private int action;
	...
	public boolean isHasCard(ZhengzMj card) {
	...
	public boolean isHasCardVal(int val) {
		if (cardIds != null) {
			List<ZhengzMj> majiangs = ZhengzMjQipaiTool.toMajiang(cardIds);
			List<Integer> vals = ZhengzMjQipaiTool.toMajiangVals(majiangs);
			return vals.contains(val);
		}
		return false;

	}
	public boolean isHasCardVal(ZhengzMj card) {
		if (cardIds != null) {
			List<ZhengzMj> majiangs = ZhengzMjQipaiTool.toMajiang(cardIds);
			List<Integer> vals = ZhengzMjQipaiTool.toMajiangVals(majiangs);
	...
	public int removeCardVal(int val) {
		if (cardIds != null) {
			...
			while (iterator.hasNext()) {
				...
				ZhengzMj majiang = ZhengzMj.getMajang(id);
