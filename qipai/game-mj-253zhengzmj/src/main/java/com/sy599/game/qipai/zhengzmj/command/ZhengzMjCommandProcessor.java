package com.sy599.game.qipai.zhengzmj.command;
...
import com.sy599.game.qipai.zhengzmj.command.com.ZhengzMjComCommand;
import com.sy599.game.qipai.zhengzmj.command.play.ZhengzMjPlayCommand;
import com.sy599.game.util.LogUtil;
import com.sy599.game.websocket.constant.WebSocketMsgType;
import com.sy599.game.websocket.netty.coder.MessageUnit;

public class ZhengzMjCommandProcessor extends AbstractBaseCommandProcessor {
    private static ZhengzMjCommandProcessor processor = new ZhengzMjCommandProcessor();
    ...
    static {
        commandMap.put(WebSocketMsgType.cs_com, ZhengzMjComCommand.class);
        commandMap.put(WebSocketMsgType.cs_play, ZhengzMjPlayCommand.class);
    ...
    public static ZhengzMjCommandProcessor getInstance() {
        return processor;
    }
    ...
    public void process(Player player, MessageUnit message) {
        int code = 0;
        try {
            ZhengzMjPlayer _player = player.getPlayer(processor);
