package com.sy599.game.qipai.zhengzmj.constant;
...
public class ZhengzMjConstants {
...
//        }
    ...
    public static List<ZhengzMj> getMajiangPai() {
        List<ZhengzMj> majiangs = new ArrayList<>();
        for (int i = 1; i <= 27; i++) {
            majiangs.add(ZhengzMj.getMajang(i));
        }
        return majiangs;
    }
}
