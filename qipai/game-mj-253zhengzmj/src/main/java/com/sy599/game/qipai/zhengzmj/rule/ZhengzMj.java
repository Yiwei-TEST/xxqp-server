...
public enum ZhengzMj {
    ...
    static ZhengzMj[] mjArray;
    public static ZhengzMj[] fullMj = new ZhengzMj[34];
    ...
    public static ZhengzMj getMajang(int id) {
        return ZhengzMj.valueOf(ZhengzMj.class, "mj" + id);
    }
    
    public static ZhengzMj getMajangVal2(int val) {
    	for(int i=0;i<fullMj.length;i++){
    		ZhengzMj mj= fullMj[i];
    		if(mj.getVal()==val){
    			return mj;
    		}
    	}
    ...
    public static List<ZhengzMj> getSameMjList(int count,int val,List<ZhengzMj> handMjs){
    	
    	
    	ZhengzMj mj = getMajangVal2(val);
    	List<ZhengzMj> mjs= new ArrayList<>();
    	if(count==0){
    		return mjs;
    	}
    	List<ZhengzMj> wangs = getWangMj(val, handMjs);
    	...
    	for(int i=0;i<4;i++){
    		...
    		if(val<201){
    			...
    			ZhengzMj mj2 = getMajang(id);
        		if(mj2.getVal()!=mj.getVal()){
        			id -=3;
        		}
    		}
    		
    		ZhengzMj dzmj = getMajang(id);
...
//    		}
    ...
    private static List<ZhengzMj>  getWangMj(int val,List<ZhengzMj> handMjs){
    	List<ZhengzMj> mjs= new ArrayList<>();
    	for(ZhengzMj mj:handMjs ){
    		if(mj.getVal()==val){
    			mjs.add(mj);
    		}
    	}
    ...
    public static ZhengzMj getMajiangByVal(int val) {
