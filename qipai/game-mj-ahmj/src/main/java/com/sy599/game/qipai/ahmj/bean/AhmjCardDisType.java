...
public class AhmjCardDisType {
    ...
    public boolean isHasCard(Ahmj card) {
    ...
    public boolean isHasCardVal(int val) {
        if (cardIds != null) {
            List<Ahmj> majiangs = AhmjHelper.toMajiang(cardIds);
            List<Integer> vals = AhmjHelper.toMajiangVals(majiangs);
    ...
    public boolean isHasCardVal(Ahmj card) {
        if (cardIds != null) {
            List<Ahmj> majiangs = AhmjHelper.toMajiang(cardIds);
            List<Integer> vals = AhmjHelper.toMajiangVals(majiangs);
    ...
    public int removeCardVal(int val) {
        if (cardIds != null) {
            ...
            while (iterator.hasNext()) {
                ...
                Ahmj majiang = Ahmj.getMajang(id);
