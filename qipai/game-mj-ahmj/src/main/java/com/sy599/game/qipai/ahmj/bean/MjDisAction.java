...
public class MjDisAction {
	...
	public static List<Integer> findPriorityAction(int action) {
		...
		if (action == MjDisAction.action_chi) {
			findActionList = Arrays.asList(MjDisAction.action_hu, MjDisAction.action_minggang, MjDisAction.action_buzhang, MjDisAction.action_peng);

		} else if (action == MjDisAction.action_peng) {
			findActionList = Arrays.asList(MjDisAction.action_hu, MjDisAction.action_minggang, MjDisAction.action_buzhang);

		} else if (action == MjDisAction.action_buzhang) {
			findActionList = Arrays.asList(MjDisAction.action_hu, MjDisAction.action_minggang);

		} else if (action == MjDisAction.action_minggang) {
			findActionList = Arrays.asList(MjDisAction.action_hu);
