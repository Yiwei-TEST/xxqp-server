package com.sy599.game.qipai.xpepaohuzi.command.play;
 ...
 * @date 2019/9/2
 */
public class PlayCommand extends BaseCommand<XPPaohuziPlayer> {

    @Override
    public void execute(XPPaohuziPlayer player, MessageUnit message) throws Exception {
        XPPaohuziTable table = player.getPlayingTable(XPPaohuziTable.class);
